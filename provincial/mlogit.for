...
C---------------------------------------------------------------------
      ...
      include 'stadat.inc'
c
      integer*2         time,iz,jz,ista,ix,itemp,itemp2
      integer*2         unit,orgzn,destzn,type,imode,iter,cp
      ...
      integer*2         zindur(max_stations,2),zindcr(max_stations,2)
      integer*2         osta(2,12),asta(2,12),tsta,tdsta,dsta(2,10,2)
      ...
      integer*2         cpx,cp1,cp3,av,av4,yindex,zindex,avcv,tindex
      integer*2         prosta3(2,12),prasta3(2,12),pindex,printzn
      integer*2         prcstat,prgrsta1,prgrsta2,asta4(24),prasta4(24)
      integer*2         deststa(max_stations),stasel(1000),stachoice(2)
      ...
      real*4            htrel(4000),toltrel(4000)
      ...
      real*4            trel2p(4000),toltrel2p(4000)
      real*4            toldist3p(4000),tollcost3p(4000)
      real*4            hdist3p(4000),htime3p(4000)
      real*4            tdist3p(4000),ttime3p(4000),ytolds3
      real*4            trel3p(4000),toltrel3p(4000)
      real*4            hovdist3(4000),hov_toldist3(4000)
c
      real*4            avhdist(4000),avhtime(4000)
      real*4            avhtrel(4000),avtoltrel(4000)
      real*4            avtdist(4000),avttime(4000)
      real*4            avtoldist(4000),avhov_toldist(4000)
      real*4            avhovdist(4000),avtollcost(4000)
      real*4            avtollcost2p(4000)
      real*4            avtoldist2p(4000)
      real*4            avhdist2p(4000),avhtime2p(4000)
      real*4            avtdist2p(4000),avttime2p(4000)
      real*4            avtrel2p(4000),avtoltrel2p(4000)
      real*4            avtoldist3p(4000),avtollcost3p(4000)
      real*4            avhdist3p(4000),avhtime3p(4000)
      real*4            avtdist3p(4000),avttime3p(4000)
      real*4            avtrel3p(4000),avtoltrel3p(4000)
      real*4            avhovdist3(4000),avhov_toldist3(4000)
c
      real*4            pertrp1(4000),pertrp2(4000)
      real*4            pertrp3(4000),tperin(6),tperson
      real*4            pertrp4(4000),pertrp5(4000)
      real*4            pertrp6(4000),pertrp,tmotor,pertrpcp
      real*4            walktime(4000),biketime(4000)
      real*4            upxivt(1000,1000),lsum3rl
      real*4            hztime(1000,4000),hzdist(1000,4000)
      real*4            wutil(2,5),tutil,twdist,butil(2,2)
      real*4            pnrrat,pnrrat2,putil(2,10),hwydst(4000)
      real*4            pdrvutil,kdrvutil,lsum2rl,ubercost(2,10)
      real*4            kutil(2,10),wait1a,wait1b,uberutil(2,10)
      ...
      real*4            tcru,tcru1,tcru2,tcru3,tcru4
      real*4            turu,turu1,turu2,turu3,turu4
      ...
      real*4            lscwlk,lscbus,lscpr,lsckr,lscr,cuprob(6)
      real*4            cuprobair,vskmtrp(4000,25)
      real*4            uwprob(3),ubprob(3),upprob(5),ukprob(5)
      real*4            lscur,uuprob(6),lsuur,lsckr2,lsukr2
      ...
      real*4            tfac,dut,edut,mfval,cfare,dirwalk(1000,4000)
      real*4            auttrp(4000,23),outtrp(4000,17)
      ...
      real*4            utran(max_izones,max_stations)
      ...
      real*4            uruber(max_stations,max_izones)
      real*4            crurstaz(max_stations,max_izones)
      real*4            cruruber(max_stations,max_izones)
      ...
      real*4            lsauto,atprob(2),autexp,lsmot,motor(4),rativt
      ...
      real*4            nmprob(2),lsnmot,tnmot,tnmbk,tnmwk
      ...
      real*4            tupx,expuber,tuberacc,tuberair,ttaxiair
      ...
      real*4            utilcp(3),eutilcp(3),probcp(3),cpms(7,3,7)
      real*4            taxicost,taxitoll,utiltaxi,ranval,kwait,txwait
      real*4            costuber,utiluber,maasprob(2),lsmaas,accuber
      real*4            tmaas,tuber,costpark,aparktrp(3,2)
      real*4            homecost,altwrk,altoth,expwrk,expoth,probwrk
      real*4            tresodat(52,24),tresoegr(24,3),proboth
      real*4            vehattr(4000,11),hhldav(4),uberav(4)
      real*4            upxsta(max_stations,max_stations)
      real*4            bchoice,bustlf(2,22),zstatime(2)
      real*8            denom,tesum(58,7),stasum(1000,13)
      real*8            stasum2(max_stations,8),maxvalue
      real*8            stasum3(max_stations,5),egrwalk(51,4)
      ...
      real*8            txfers(6,6),tottrn(31,31,6),gorail(21,21)
      ...
      real*8            nonmot(41,41,3),spdist(31,31,50),spsum(51,10)
      real*8            taxisum(41,41),taxiwait(100,7),taxitlf(1001)
      real*8            htreltlf(52,3),htrelrat(52,3),toltrelf(52)
      real*8            trel2ptlf(52,2),toltrel2ptlf(52,4)
      logical           csort,eventsp,homeav,print
      character*13      name(2),tname(6),nname(4),autoname(4)
      character*20      cpseg(3)
     ...
     *                          'Lakeshore East',
     *                          'Union Station'/
      data             cpseg/'Drive-alone captive',
     *                       'Shared-ride captive','Flexible'/
...
c -------------------------------------------------------------
      imode=1
      call station(stasta,imode,upxivt)
      imode=2
      call station(stasta,imode,upxivt)
c ---------------------------------------------------------------
c     read & store time and distance from station to zone
c ---------------------------------------------------------------
      if(trnegr) then
      type=1
      do iz=1,max_izones
      ...
      j=jz-max_izones
      hztime(j,iz)=htime(jz)
      hzdist(j,iz)=hdist(jz)
      if(htime(jz).le.0.or.hdist(jz).le.0) then
      hztime(j,iz)=999.9
      hzdist(j,iz)=999.9
      end if
      end do
...
c ---------------------------------------------------------------
      if(trnegr) then
      do imode=1,2
      call egrprob(stazne,imode,zonesta,staznei,hztime,hzdist,staegr,
     *             dirwalk)
      end do
      call egress(stazne,3,zonesta,staznei)
      else
      do imode=1,3
...
C.....FARE
C     unit=25
C     call mfread(unit,type,orgzn,destzn,bstrfare,srow,prow,arow)
C...LOCAL BUS IN-VEHICLE TIME
      unit=67
...
C.....FARE
C     unit=25
C     call mfread(unit,type,orgzn,destzn,rapdfare,srow,prow,arow)
C...LOCAL BUS IN-VEHICLE TIME
      unit=75
...
c -----------------------------------------------------------
c     obtain reliability matrices, if requested
c -----------------------------------------------------------
      IF(HWYREL) THEN
C.....NON-TOLL TRAVEL TIME RELIABILITY
      unit=195
      call mfread(unit,type,orgzn,destzn,htrel,srow,prow,arow)
C.....TOLL TRAVEL TIME RELIABILITY
      unit=196
      call mfread(unit,type,orgzn,destzn,toltrel,srow,prow,arow)
C.....HOV NON-TOLL TRAVEL TIME RELIABILITY
      unit=197
      call mfread(unit,type,orgzn,destzn,trel2p,srow,prow,arow)
C.....HOV TOLL TRAVEL TIME RELIABILITY
      unit=198
      call mfread(unit,type,orgzn,destzn,toltrel2p,srow,prow,arow)
      END IF
c -----------------------------------------------------------
c     obtain 3+ person skim matrices
c -----------------------------------------------------------
      if(hwy3p) then
C.....HOV NON-TOLL TIME
      unit=220
      call mfread(unit,type,orgzn,destzn,htime3p,srow,prow,arow)
C.....HOV NON-TOLL DISTANCE
      unit=221
      call mfread(unit,type,orgzn,destzn,hdist3p,srow,prow,arow)
C.....HOV DISTANCE
      unit=222
      call mfread(unit,type,orgzn,destzn,hovdist3,srow,prow,arow)
C.....HOV TOLL TIME
      unit=223
      call mfread(unit,type,orgzn,destzn,ttime3p,srow,prow,arow)
C.....HOV TOLL DISTANCE
      unit=224
      call mfread(unit,type,orgzn,destzn,tdist3p,srow,prow,arow)
C.....HOV TOLL LANE DISTANCE
      unit=225
      call mfread(unit,type,orgzn,destzn,toldist3p,srow,prow,arow)
C.....HOV TOLL COST
      unit=226
      call mfread(unit,type,orgzn,destzn,tollcost3p,srow,prow,arow)
C.....HOV TOLL LANE DISTANCE
      unit=227
      call mfread(unit,type,orgzn,destzn,hov_toldist3,srow,prow,arow)
      if(hwyrel) then
C.....HOV NON-TOLL TRAVEL TIME RELIABILITY
      unit=228
      call mfread(unit,type,orgzn,destzn,trel3p,srow,prow,arow)
C.....HOV TOLL TRAVEL TIME RELIABILITY
      unit=229
      call mfread(unit,type,orgzn,destzn,toltrel3p,srow,prow,arow)
      end if
      else
      do jjz=1,4000
      htime3p(jjz)=htime2p(jjz)
      hdist3p(jjz)=hdist2p(jjz)
      hovdist3(jjz)=hovdist(jjz)
      trel3p(jjz)=trel2p(jjz)
      ttime3p(jjz)=ttime2p(jjz)
      tdist3p(jjz)=tdist2p(jjz)
      toldist3p(jjz)=toldist2p(jjz)
      tollcost3p(jjz)=tollcost2p(jjz)
      hov_toldist3(jjz)=hov_toldist(jjz)
      toltrel3p(jjz)=toltrel2p(jjz)
      end do
      end if
C
C     SCALE HIGHWAY RELIABILITY VALUES
C
      if(hwyrel) then
      do jjz=1,4000
      htrel(jjz)=htrel(jjz)*relfctr
      toltrel(jjz)=toltrel(jjz)*relfctr
      trel2p(jjz)=trel2p(jjz)*relfctr
      toltrel2p(jjz)=toltrel2p(jjz)*relfctr
      trel3p(jjz)=trel3p(jjz)*relfctr
      toltrel3p(jjz)=toltrel3p(jjz)*relfctr  
      end do    
      end if
c -----------------------------------------------------------
...
C.....NON-TOLL TIME
      unit=231
      call mfread(unit,type,orgzn,destzn,avhtime,srow,prow,arow)
C.....NON-TOLL DISTANCE
      unit=232
      call mfread(unit,type,orgzn,destzn,avhdist,srow,prow,arow)
C.....TOLL TIME
      unit=233
      call mfread(unit,type,orgzn,destzn,avttime,srow,prow,arow)
C.....TOLL DISTANCE
      unit=234
      call mfread(unit,type,orgzn,destzn,avtdist,srow,prow,arow)
C.....TOLL LANE DISTANCE
      unit=235
      call mfread(unit,type,orgzn,destzn,avtoldist,srow,prow,arow)
C.....TOLL COST
      unit=236
      call mfread(unit,type,orgzn,destzn,avtollcost,srow,prow,arow)
c -----------------------------------------------------------
c     obtain 2-person skim matrices
c -----------------------------------------------------------
C.....HOV NON-TOLL TIME
      unit=239
      call mfread(unit,type,orgzn,destzn,avhtime2p,srow,prow,arow)
C.....HOV NON-TOLL DISTANCE
      unit=240
      call mfread(unit,type,orgzn,destzn,avhdist2p,srow,prow,arow)
C.....HOV DISTANCE
      unit=241
      call mfread(unit,type,orgzn,destzn,avhovdist,srow,prow,arow)
C.....HOV TOLL TIME
      unit=242
      call mfread(unit,type,orgzn,destzn,avttime2p,srow,prow,arow)
C.....HOV TOLL DISTANCE
      unit=243
      call mfread(unit,type,orgzn,destzn,avtdist2p,srow,prow,arow)
C.....HOV TOLL LANE DISTANCE
      unit=244
      call mfread(unit,type,orgzn,destzn,avtoldist2p,srow,prow,arow)
C.....HOV TOLL COST
      unit=245
      call mfread(unit,type,orgzn,destzn,avtollcost2p,srow,prow,arow)
C.....HOV TOLL LANE DISTANCE
      unit=246
      call mfread(unit,type,orgzn,destzn,avhov_toldist,srow,prow,arow)
c -----------------------------------------------------------
c     obtain reliability matrices, if requested
c -----------------------------------------------------------
      IF(HWYREL) THEN
C.....NON-TOLL TRAVEL TIME RELIABILITY
      unit=237
      call mfread(unit,type,orgzn,destzn,avhtrel,srow,prow,arow)
C.....TOLL TRAVEL TIME RELIABILITY
      unit=238
      call mfread(unit,type,orgzn,destzn,avtoltrel,srow,prow,arow)
C.....HOV NON-TOLL TRAVEL TIME RELIABILITY
      unit=247
      call mfread(unit,type,orgzn,destzn,avtrel2p,srow,prow,arow)
C.....HOV TOLL TRAVEL TIME RELIABILITY
      unit=248
      call mfread(unit,type,orgzn,destzn,avtoltrel2p,srow,prow,arow)
      END IF
c -----------------------------------------------------------
c     obtain 3+ person skim matrices
c -----------------------------------------------------------
...
C.....HOV NON-TOLL TIME
      unit=249
      call mfread(unit,type,orgzn,destzn,avhtime3p,srow,prow,arow)
C.....HOV NON-TOLL DISTANCE
      unit=250
      call mfread(unit,type,orgzn,destzn,avhdist3p,srow,prow,arow)
C.....HOV DISTANCE
      unit=251
      call mfread(unit,type,orgzn,destzn,avhovdist3,srow,prow,arow)
C.....HOV TOLL TIME
      unit=252
      call mfread(unit,type,orgzn,destzn,avttime3p,srow,prow,arow)
C.....HOV TOLL DISTANCE
      unit=253
      call mfread(unit,type,orgzn,destzn,avtdist3p,srow,prow,arow)
C.....HOV TOLL LANE DISTANCE
      unit=254
      call mfread(unit,type,orgzn,destzn,avtoldist3p,srow,prow,arow)
C.....HOV TOLL COST
      unit=255
      call mfread(unit,type,orgzn,destzn,avtollcost3p,srow,prow,arow)
C.....HOV TOLL LANE DISTANCE
      unit=256
      call mfread(unit,type,orgzn,destzn,avhov_toldist3,srow,prow,arow)
      if(hwyrel) then
C.....HOV NON-TOLL TRAVEL TIME RELIABILITY
      unit=257
      call mfread(unit,type,orgzn,destzn,avtrel3p,srow,prow,arow)
C.....HOV TOLL TRAVEL TIME RELIABILITY
      unit=258
      call mfread(unit,type,orgzn,destzn,avtoltrel3p,srow,prow,arow)
      end if
      else
      do jjz=1,4000
      avhtime3p(jjz)=avhtime2p(jjz)
      avhdist3p(jjz)=avhdist2p(jjz)
      avhovdist3(jjz)=avhovdist(jjz)
      avtrel3p(jjz)=avtrel2p(jjz)
      avttime3p(jjz)=avttime2p(jjz)
      avtdist3p(jjz)=avtdist2p(jjz)
      avtoldist3p(jjz)=avtoldist2p(jjz)
      avtollcost3p(jjz)=avtollcost2p(jjz)
      avhov_toldist3(jjz)=avhov_toldist(jjz)
      avtoltrel3p(jjz)=avtoltrel2p(jjz)
      end do
      end if
      end if
C---------------------------------------------------------------
...
C
      ...
      tperin(6)=pertrp6(JZ)
C
C    SET PERSON TRIPS TO 100 FOR TRESO
C
      if(treso) then
      do k=1,ncats
      tperin(k)=tperin(k)*100.0
      end do
      end if
c
     ...
     *        tperin(5)+tperin(6)
C....................................................................
      IF((tperson.le.0.0.or.treso).and.(debug)) THEN
      tperin(1)=100.0
      tperin(2)=100.0
      tperin(3)=100.0
      tperin(4)=100.0
...
c---------------------------------------------------------------
     ...
     *   wdsta(imode,ista),imode,zonesta,staegr,PRINT)
...
C     IF(WUTIL(IMODE,ISTA).GT.WUTIL(IMODE,(ISTA-1))) THEN
...
c
     ...
     *           matr,morg,mdst,mind,mutil,staegr)
      if(matr.le.0) cycle
...
c...........................................................
      ...
      if(debug) write(26,9660) 
 9660 format(' URBAN RAIL PATH NOT SELECTED'/
     *       ' ----------------------------'/)
      end if
	    end do
C ------------------------------------------------------------
...
C ------------------------------------------------------------
 ...
 7301 FORMAT(/' BUS ACCESS TO ',a13)
     ...
     *   DESTSTA(ISTA),IMODE,ZONESTA,STAEGR,PRINT)
      PRINT=.TRUE.
      IF(DESTSTA(ISTA).EQ.0) CYCLE
      BUSUTIL=BUSACC(ISTA)+
     *  STASTA(2,ISTA,(DESTSTA(ISTA)-MAX_IZONES)) +
     *  STAEGR(3,(DESTSTA(ISTA)-MAX_IZONES),JZ)
C......................................................................
      IF(SDETAIL) THEN
      WRITE(26,7302) IEQUIV((ISTA+MAX_IZONES)),BUSACC(ISTA),
     *     IEQUIV(DESTSTA(ISTA)),
     *     STASTA(2,ISTA,(DESTSTA(ISTA)-MAX_IZONES)),
...
C.....................................................................
     ...
     *                IEQUIV(BSTA(IMODE,1)),
     *                STANAME(BSTA(IMODE,1)-MAX_IZONES),
     *                BDIST(IMODE,1),
     *                BUSACC(BSTA(IMODE,1)-MAX_IZONES),
     *                IEQUIV(BSTA(IMODE,2)),
     *                STANAME(BSTA(IMODE,2)-MAX_IZONES),
     *                BDIST(IMODE,2),
 ...
 7303 FORMAT(//' BUS ACCESS STATION SELECTION FOR ',A13/
     ...
     *       ' ACCESS UTILITY=',F10.5)
      ...
      ORISTA=0
      DESSTA=0
      IF(BSTA(IMODE,1).GT.0) ORISTA=IEQUIV(BSTA(IMODE,1))
      IF(BSTA(IMODE,2).GT.0) DESSTA=IEQUIV(BSTA(IMODE,2))
      WRITE(26,7304)  NAME(IMODE),
     *                ORISTA,BDIST(IMODE,1),
     *                DESSTA,BDIST(IMODE,2)
...
c-------------------------------------------------
   ...
   41  FORMAT(/' BUS ACCESS #',I1,' ---> ',a13/
     ...
     *   BDSTA(imode,ista),IMODE,ZONESTA,staegr,PRINT)
...
c
     ...
     *           stasta,stazne,msta(ista),crdsta(ista),mutil,staegr)
      end if
...
C..COMMUTER RAIL
  ...
  341  FORMAT(/' DRIVE ACCESS #',I2,' ---> ',a13/
     ...
     *          IMODE,ZONESTA,staegr,PRINT)
      DSTA(IMODE,IX,1)=ITEMP2
      CALL PUTL(IX,IZ,JZ,ZINDCR(IX,1),
     *  DSTA(imode,IX,1),PUTIL(imode,IX),STASTA,STAZNE,hstime,hsdist,
     *  IMODE,PNRRAT,PNRRAT2,hwydst,pdrvutil,staegr)
c     CRPNR(IX)=PNRRAT
c     CRPNR2(IX)=PNRRAT2
     ...
     *          IMODE,ZONESTA,staegr,PRINT)
      ...
      CALL KUTL(IX,IZ,JZ,ZINDCR(IX,2),
     *  DSTA(imode,IX,2),KUTIL(imode,IX),STASTA,STAZNE,hstime,hsdist,
     *  IMODE,kdrvutil,uberutil(imode,ix),ubercost(imode,ix),staegr)
      WRITE(190,9343) IX,(KUTIL(1,K),K=1,10)
 9343 FORMAT(' IX=',I2,' KUTIL=',10(1X,F12.5))
c
c     station level utilities for 4-part path analysis
c
      if(zindcr(ix,1).eq.0) go to 343
      call part4(jz,(zindcr(ix,1)+max_izones),stasta,stazne,imode,
     *           matr,morg,mdst,mind,mutil,staegr)
      if(matr.le.0) go to 343
      walk1=stazne(3,(dsta(imode,ix,1)-max_izones),jz)*coeff(7)
c
...
c...........................................................
      ...
      dsta(imode,ix,1)=matr+max_izones
      pdsta1(imode,ix)=morg+max_izones
      pdsta2(imode,ix)=mdst+max_izones
      pind(imode,ix)=mind
c..........................................................
      if(debug) write(26,9023) mutilp,iequiv(dsta(imode,ix,1)),
...
c...........................................................
  ...
  343 continue
      if(zindcr(ix,2).eq.0) go to 342
      call part4(jz,(zindcr(ix,2)+max_izones),stasta,stazne,imode,
     *           matr,morg,mdst,mind,mutil,staegr)
...
c.................................................................
      ...
      kind(imode,ix)=0
      if(.not.backver) then
      if(mutilk.gt.cutil) then
      kutil(imode,ix)=mutilk
      dsta(imode,ix,2)=matr+max_izones
      kdsta1(imode,ix)=morg+max_izones
      kdsta2(imode,ix)=mdst+max_izones
      kind(imode,ix)=mind
c..........................................................
      if(debug) write(26,9023) mutilk,iequiv(dsta(imode,ix,2)),
...
C...URBAN RAIL
     ...
     *          IMODE,ZONESTA,staegr,PRINT)
      DSTA(IMODE,IX,1)=ITEMP2
      CALL PUTL(IX,IZ,JZ,ZINDUR(IX,1),
     *  DSTA(imode,IX,1),PUTIL(imode,IX),STASTA,STAZNE,hstime,hsdist,
     *  IMODE,PNRRAT,PNRRAT2,hwydst,pdrvutil,staegr)
     ...
     *          IMODE,ZONESTA,staegr,PRINT)
      DSTA(IMODE,IX,2)=ITEMP2
      CALL KUTL(IX,IZ,JZ,ZINDUR(IX,2),
     *  DSTA(imode,IX,2),KUTIL(imode,IX),STASTA,STAZNE,hstime,hsdist,
     *  IMODE,kdrvutil,uberutil(imode,ix),ubercost(imode,ix),staegr)
      end do
C      WRITE(26,9342) (KUTIL(1,K),K=1,10)
C.....SORT DRIVE ACCESS STATIONS - GO RAIL
      IMODE=1
      CALL USORT(1,PSTA,ZINDCR,DSTA,PDSTA,PUTIL,IMODE,
     *           PDSTA1,PDSTA2,PIND,UBERUTIL,UBERCOST)
     ...
     *           KDSTA1,KDSTA2,KIND,UBERUTIL,UBERCOST)
...
C     BSTRFARE(JZ)=BSTRFARE(JZ)*100.0
      BSTRFARE(JZ)=BFARETTC*100.0
...
C     RAPDFARE(JZ)=RAPDFARE(JZ)*100.0
      RAPDFARE(JZ)=BFARETTC*100.0
...
C....................................................................
     ...
     *               (KUTIL(2,K4),K4=1,4),(UBERUTIL(2,K5),K5=1,4),
 ...
 9000 FORMAT(/1X,'SUMMARY OF LOWER LEVEL UTILITY VALUES'/
     ...
     *       1X,'GO       RAIL  UBER-->STA #1 UTILITY=',F10.5/
     *       1X,'GO       RAIL  UBER-->STA #2 UTILITY=',F10.5/
     *       1X,'GO       RAIL  UBER-->STA #3 UTILITY=',F10.5/
     *       1X,'GO       RAIL  UBER-->STA #4 UTILITY=',F10.5//
     ...
     *       1X,'TTC      RAIL  UBER-->STA #1 UTILITY=',F10.5/
     *       1X,'TTC      RAIL  UBER-->STA #2 UTILITY=',F10.5/
     *       1X,'TTC      RAIL  UBER-->STA #3 UTILITY=',F10.5/
     *       1X,'TTC      RAIL  UBER-->STA #4 UTILITY=',F10.5//
...
C
 ...
 9004 FORMAT(//1X,'ORIGIN --> DESTINATION STATION SUMMARY'/
     ...
     *       1X,'GO    BUS    DRIVE -->STA    ',I4/)
      IF(.NOT.TRNEGR) WRITE(26,9064) (PROSTA3(1,K),PRASTA3(1,K),K=1,12)
...
C
      ...
      avcv=(c-1)*4+av+16
C -------------------------------------------------------------------------
      IF(DEBUG.AND.AVMDL) THEN
      WRITE(26,453) C,AV,HHLDAV(AV),ZHHD(AVCV,IZ)
  453 FORMAT(/
...
C
      ...
      HOMECOST=OPCOST*HDIST(JZ)
C.............................................................
      IF(DEBUG) THEN
      PRINTZN=0
      IF(APRKZONE(JZ).GT.0) PRINTZN=IEQUIV(APRKZONE(JZ))
      WRITE(26,55555) IEQUIV(JZ),HOMECOST,PRKCST(JZ),
     *                APRKCST(JZ),PRINTZN
55555 FORMAT('     PARKING COST CHOICE MODEL'/
     ...
     *       ' ALTERNATE LOCATION ZONE        =',I8/)
      END IF
C................................................................
      ALTWRK=COEFF(50+C)*PRKCST(JZ)
      IF(HOMECOST.LT.APRKCST(JZ)) THEN
      ALTOTH=COEFF(50+C)*HOMECOST
      HOMEAV=.TRUE.
      ELSE
      ALTOTH=COEFF(50+C)*APRKCST(JZ)
      HOMEAV=.FALSE.
      END IF
      EXPWRK=0.0
      EXPOTH=0.0
      ...
      PROBOTH=0.0
      END IF
      COSTPARK=PROBWRK*PRKCST(JZ)+PROBOTH*APRKCST(JZ)
      IF(HOMEAV) COSTPARK=PROBWRK*PRKCST(JZ)+PROBOTH*HOMECOST
...
C....NON-TOLL  
      ...
      UTIL0NT=COEFF(11)* HTIME(JZ) * (1.0-HHLDAV(AV))
     *        +COEFF(58) * AVHTIME(JZ) * HHLDAV(AV)
     *        +COEFF(50+C)* COSTPARK/2.0
     *        +COEFF(50+C)* OPCOST*HDIST(JZ)
     *        +COEFF(57)* HTREL(JZ) * (1.0-HHLDAV(AV))
     *        +COEFF(59)* AVHTREL(JZ) * HHLDAV(AV)
...
C....TOLL 
      ...
      UTIL0T = COEFF(11)* TTIME(JZ) * (1.0-HHLDAV(AV))
     *        +COEFF(58) * AVTTIME(JZ) * HHLDAV(AV)
     *        +COEFF(50+C)* COSTPARK/2.0
     *        +COEFF(50+C)* OPCOST* TDIST(JZ)
     *        +COEFF(70+C)* TOLLCOST(JZ)
     *        +COEFF(57)* TOLTREL(JZ)* (1.0-HHLDAV(AV))
     *        +COEFF(59)* AVTOLTREL(JZ) * HHLDAV(AV)
     *        + YTOLDS0  +KTOLL
...
C....NON-TOLL/NON-HOV (BASED UPON DRIVE ALONE)
      IF(HTIME(JZ).GT.0) THEN
      UTIL2NT =COEFF(11)* HTIME(JZ)* (1.0-HHLDAV(AV))
     *        +COEFF(58) * AVHTIME(JZ) * HHLDAV(AV)
     *        +COEFF(50+C)* COSTPARK/(HOV2P*2.0)
...
C....HOV UTILITY FOR NON-TOLL CHOICE
      ...
      UTIL2NTH=COEFF(11)* HTIME2P(JZ) * (1.0-HHLDAV(AV))
     *        +COEFF(58)* AVHTIME2P(JZ) * HHLDAV(AV)
     *        +COEFF(50+C)* COSTPARK/(HOV2P*2.0)
     *        +COEFF(50+C)* OPCOST* HDIST2P(JZ)/HOV2P
     *        +COEFF(57)* TREL2P(JZ) * (1.0-HHLDAV(AV))
     *        +COEFF(59)* AVTREL2P(JZ) * HHLDAV(AV)
     *        +KHOV2 
      UTIL2NTH=UTIL2NTH/(LSUM1AUTO*LSUM2AUTO*LSUM3AUTO)
      END IF
C....TOLL/NON-HOV (BASED UPON DRIVE ALONE)
      IF((TTIME(JZ).GT.0).AND.(TOLDIST(JZ).GT.0.01)) THEN
      UTIL2T = COEFF(11)* TTIME(JZ) * (1.0-HHLDAV(AV))
     *        +COEFF(58)* AVTTIME(JZ) * HHLDAV(AV)
     *        +COEFF(50+C)* COSTPARK/(HOV2P*2.0)
...
C....HOV UTILITY FOR TOLL CHOICE
      ...
      UTIL2TH= COEFF(11)* TTIME2P(JZ) * (1.0-HHLDAV(AV))
     *        +COEFF(58) * AVTTIME2P(JZ) * HHLDAV(AV)
     *        +COEFF(50+C)* COSTPARK/(HOV2P*2.0)
     *        +COEFF(50+C)* OPCOST* TDIST2P(JZ)/HOV2P
     *        +COEFF(70+C)* (DSCT2P*TOLLCOST2P(JZ))/HOV2P
     *        +COEFF(57)* TOLTREL2P(JZ) * (1.0-HHLDAV(AV))
     *        +COEFF(59) * AVTOLTREL2P(JZ) * HHLDAV(AV)
...
C
      IF(HTIME(JZ).GT.0) THEN
      UTIL3NT =COEFF(11)* HTIME(JZ) * (1.0-HHLDAV(AV))
     *        +COEFF(58) * AVHTIME(JZ) * HHLDAV(AV)
     *        +COEFF(57)* HTREL(JZ) * (1.0-HHLDAV(AV))
     *        +COEFF(59) * AVHTREL(JZ) * HHLDAV(AV)
     ...
     *        +COEFF(50+C)* OPCOST*(HDIST(JZ)/HOV3P)
      ...
      END IF
C....HOV UTILITY FOR NON-TOLL CHOICE
	IF(HOVDIST3(JZ).GT.0.01) THEN
      UTIL3NTH =COEFF(11)* HDIST3P(JZ) * (1.0-HHLDAV(AV))
     *        +COEFF(58) * AVHDIST3P(JZ) * HHLDAV(AV)
     *        +COEFF(57)* TREL3P(JZ) * (1.0-HHLDAV(AV))
     *        +COEFF(59) * AVTREL3P(JZ) * HHLDAV(AV)
     *        +COEFF(50+C)* PRKCST(JZ)/(HOV3P*2.0)
     *        +COEFF(50+C)* OPCOST* HDIST3P(JZ)/HOV3P
     *        +KHOV3 
      UTIL3NTH=UTIL3NTH/(LSUM1AUTO*LSUM2AUTO*LSUM3AUTO)
      END IF
C....TOLL/NON-HOV (BASED UPON DRIVE ALONE)
      IF((TTIME(JZ).GT.0).AND.(TOLDIST(JZ).GT.0.01)) THEN
      UTIL3T = COEFF(11)* TTIME(JZ) * (1.0-HHLDAV(AV))
     *        +COEFF(58) * AVTTIME(JZ) * HHLDAV(AV)
     *        +COEFF(57)* TOLTREL(JZ) * (1.0-HHLDAV(AV))
     *        +COEFF(59) * AVTOLTREL(JZ) * HHLDAV(AV)
     *        +COEFF(50+C)* PRKCST(JZ)/(HOV3P*2.0)
     ...
     *        + YTOLDS0  +KTOLL3
      ...
      END IF
C....HOV UTILITY FOR TOLL CHOICE
	IF(HOV_TOLDIST3(JZ).GT.0.01) THEN
      YTOLDS3=YINTER+YSLOPE*TDIST3P(JZ)
	YTOLDS3=MIN(YTOLDS3,0.0)
      UTIL3TH= COEFF(11)* TTIME3P(JZ) * (1.0-HHLDAV(AV))
     *        +COEFF(58) * AVTTIME3P(JZ) * HHLDAV(AV)
     *        +COEFF(57)* TOLTREL3P(JZ) * (1.0-HHLDAV(AV))
     *        +COEFF(59) * AVTOLTREL3P(JZ) * HHLDAV(AV)
     *        +COEFF(50+C)* PRKCST(JZ)/(HOV3P*2.0)
     *        +COEFF(50+C)* OPCOST* TDIST3P(JZ)/HOV3P
     *        +COEFF(70+C)* (DSCT3P*TOLLCOST3P(JZ))/HOV3P
     *        +YTOLDS3 +KTOLL3 +KHOV3
...
C.....TAXI UTILITY
  175 call random(ranval)
      ...
      TAXICOST=4.25+1.75*TDIST2P(JZ)
      TAXITOLL=0.0
      IF(TOLDIST(JZ).GT.0.01) TAXITOLL=TOLLCOST(JZ)
      UTILTAXI= COEFF(11)* HTIME2P(JZ)
     *         +COEFF(12)* TXWAIT
     *         +COEFF(50+C)* (TAXICOST*100.0) 
     *         +COEFF(70+C)*  TAXITOLL
     *         +COEFF(57)*TREL2P(JZ)
     *         +KTAXI(C)
...
C.....UBER UTILITY
      IF(UBERMODE) THEN
       ...
       CALL UBERCOMP(IZ,HTIME2P(JZ),HDIST2P(JZ),COEFF(12),COEFF(11),
     *              COSTUBER,ACCUBER,KWAIT)
       ELSE
       CALL UBERCOMP(IZ,AVHTIME2P(JZ),AVHDIST2P(JZ),COEFF(12),
     *              COEFF(58),COSTUBER,ACCUBER,KWAIT)       
       END IF
      UTILUBER=ACCUBER + COEFF(50+C)* (COSTUBER*100.0)
     *        +COEFF(57)*TREL2P(JZ) * (1.0-UBERAV(AV))
     *        +COEFF(59)*AVTREL2P(JZ) * UBERAV(AV)
     *        +KUBERMODE(C)
...
C.................................................................
      IF(DEBUG) THEN
      WRITE(26,9035) IEQUIV(IZ),IEQUIV(JZ),C,AV,HHLDAV(AV),
     *               HTIME(JZ),HDIST(JZ),
     *               HTREL(JZ),TTIME(JZ),TDIST(JZ),TOLLCOST(JZ),
     *               TOLDIST(JZ),TOLTREL(JZ),YTOLDS0,
     *               HTIME2P(JZ),HDIST2P(JZ),HOVDIST(JZ),TREL2P(JZ),
     *               TTIME2P(JZ),TDIST2P(JZ),
     *               TOLDIST2P(JZ),HOV_TOLDIST(JZ),
     *               TOLLCOST2P(JZ),TOLTREL2P(JZ),DSCT2P,YTOLDS2,
     *               HTIME3P(JZ),HDIST3P(JZ),HOVDIST3(JZ),TREL3P(JZ),
     *               TTIME3P(JZ),TDIST3P(JZ),
     *               TOLDIST3P(JZ),HOV_TOLDIST3(JZ),
     *               TOLLCOST3P(JZ),TOLTREL3P(JZ),YTOLDS3,DSCT3P,
     *               COSTPARK,
     *               UTIL0NT,UTIL0T,UTIL2NT,UTIL2NTH,UTIL2T,UTIL2TH,
     *               UTIL3NT,UTIL3NTH,UTIL3T,UTIL3TH
      IF(TAXIMODE)   WRITE(26,9662) ZHHD(6,IZ),ZINDEX,
     *               HTIME2P(JZ),TXWAIT,TAXICOST,TAXITOLL,
     *               TOLDIST(JZ),UTILTAXI
      IF(UBERMODE)   WRITE(26,9661)
     *               HTIME2P(JZ),HDIST2P(JZ),KWAIT,COSTUBER,
     *               UTILUBER
 9035 FORMAT(/1X,'HIGHWAY MODE UTILITY COMPUTATIONS'/
     ...
     *       1X,'2P AUTO TIME REL-TOLL/HOV  =',F10.2/
     ...
     *       1X,'3P AUTO TIME REL     HOV   =',F10.2//
     *       1X,'3P AUTO TIME-    TOLL/HOV  =',F10.2/
     *       1X,'3P AUTO DISTANCE-TOLL/HOV  =',F10.2/
     *       1X,'3P TOLL DISTANCE-TOLL/HOV  =',F10.2/
     *       1X,'3P HOV  DISTANCE-TOLL/HOV  =',F10.2/
     *       1X,'3P TOLL COST               =',F10.2/
     *       1X,'3P AUTO TIME REL-TOLL/HOV  =',F10.2/
 ...
 9662 FORMAT(1X,'ZONAL FLOATING DENSITY     =',F10.5/
 ...
 9661 FORMAT(1X,'UBER HIGHWAY TIME          =',F10.2/
     *       1X,'UBER HIGHWAY DISTANCE      =',F10.2/
     *       1X,'UBER WAIT TIME             =',F10.2/
     *       1X,'UBER COST (DOLLARS)        =',F10.2/
     *       1X,'UBER UTILITY               =',F10.5/)
      IF(AVMDL) WRITE(26,9036) AVHTIME(JZ),AVHDIST(JZ),
     *               AVHTREL(JZ),AVTTIME(JZ),AVTDIST(JZ),
     *               AVTOLLCOST(JZ),
     *               AVTOLDIST(JZ),AVTOLTREL(JZ),
     *               AVHTIME2P(JZ),AVHDIST2P(JZ),AVHOVDIST(JZ),
     *               AVTREL2P(JZ),
     *               AVTTIME2P(JZ),AVTDIST2P(JZ),
     *               AVTOLDIST2P(JZ),AVHOV_TOLDIST(JZ),
     *               AVTOLLCOST2P(JZ),AVTOLTREL2P(JZ),
     *               AVHTIME3P(JZ),AVHDIST3P(JZ),AVHOVDIST3(JZ),
     *               AVTREL3P(JZ),
     *               AVTTIME3P(JZ),AVTDIST3P(JZ),
     *               AVTOLDIST3P(JZ),AVHOV_TOLDIST3(JZ),
     *               AVTOLLCOST3P(JZ),AVTOLTREL3P(JZ)
 9036 FORMAT(/1X,'AV HIGHWAY MODE UTILITY VARIABLES'/
     *        1X,'---------------------------------'/
     *       1X,'DA AUTO TIME-    NON TOLL  =',F10.2/
     *       1X,'DA AUTO DISTANCE-NON TOLL  =',F10.2/
     *       1X,'DA AUTO TIME REL-NON TOLL  =',F10.2//
...
C
      ...
      avcv=(c-1)*4+av+16
      PERTRP=TPERIN(C)*MWALK(M)*ZHHD(avcv,IZ)
...
C..WALK STATION #1/2
      ...
      IF(EGRIND(IMODE,IST).GT.0) CFARE=CFARE+BFARETTC*100.0
      ELSE
     ...
     *   (COEFF(50+C)*CFARE)/(LSUM1TRN*LSUM2RL*LSUM3RL)
...
C..BUS STATION #1/2
     ...
     *           -(SKIM(1,13)*BFAREGR*100.0)
      IF(EGRIND(IMODE,IST).GT.0) CFARE=CFARE+BFARETTC*100.0
      IF(MSTA(IST).GT.0) CFARE=CFARE+BFARETTC*100.0
      ELSE
      CFARE=CFARE-(STAZNE(5,SC2,JZ)*BFARETTC*100.0)
...
C
     ...
     *          (KDTRN(C)+KPNR(C))/(LSUM1TRN*LSUM2RL*LSUM3RL)
      EUTIL(ICH)=EXP(UTIL(ICH))
      END IF
      END DO
C
C..K&R STATION #1-4
     ...
     *   (COEFF(50+C)*CFARE)/(LSUM1TRN*LSUM2RL*LSUM3RL)
      EUTIL(ICH)=EXP(UTIL(ICH))
C..UBER STATION #1-4
      IF(IMODE.EQ.1)  ICK=ICH+45
      IF(IMODE.EQ.2)  ICK=ICH+37
      IF(UBERUTIL(imode,IST).NE.0.0) THEN
      UTIL(ICK)=UBERUTIL(imode,IST) + COEFF(7)*WLKM2 +
     *    KDTRN(C)/(LSUM1TRN*LSUM2RL)+
     *   (COEFF(50+C)*CFARE)/(LSUM1TRN*LSUM2RL) +
     *   (COEFF(50+C)*UBERCOST(imode,IST))/(LSUM1TRN*LSUM2RL*LSUM3RL)
      EUTIL(ICK)=EXP(UTIL(ICK))
      END IF
      END IF
      END DO
C....................................................................
 ...
 9005 FORMAT(/1X,'SUMMARY OF GO RAIL UTILITIES FOR MARKET SEGMENT=',I1/
     ...
     *       1X,'GO RAIL  UBER ->STA #1 ',F10.5,3X,E12.5/
     *       1X,'GO RAIL  UBER-->STA #2 ',F10.5,3X,E12.5/
     *       1X,'GO RAIL  UBER-->STA #3 ',F10.5,3X,E12.5/
     *       1X,'GO RAIL  UBER-->STA #4 ',F10.5,3X,E12.5/) 
      ELSE
      WRITE(26,9015) C,(UTIL(K),EUTIL(K),K=13,24),
     *               (UTIL(K),EUTIL(K),K=58,61)
 9015 FORMAT(/1X,'SUMMARY OF TTC SUBWAY UTILITIES FOR MARKET SEGMENT=',
     ...
     *       1X,'TTC SUBWAY  UBER-->STA #1 ',F10.5,3X,E12.5/
     *       1X,'TTC SUBWAY  UBER-->STA #2 ',F10.5,3X,E12.5/
     *       1X,'TTC SUBWAY  UBER-->STA #3 ',F10.5,3X,E12.5/
     *       1X,'TTC SUBWAY  UBER-->STA #4 ',F10.5,3X,E12.5/)        
      END IF
      END IF
C...................................................................
      END DO
...
C..DRIVE ACCESS TO RAPID BUS
     ...
     *         KINFLRPD/(LSUM2RB*LSUM1TRN)
      ...
      END IF
      IF(ZEROCAR.AND.C.LE.2.AND.NCATS.GT.1.AND.AV.EQ.1) THEN
      UTIL(26)=0.0
      EUTIL(26)=0.0
      UTIL(52)=0.0
      EUTIL(52)=0.0
...
C..TAXI
      IF(UTILTAXI.NE.0.0.AND.TAXIMODE) THEN
	    UTIL(76)=UTILTAXI
      EUTIL(76)=EXP(UTIL(76))
	    ENDIF
C
C..UBER
      IF(UTILUBER.NE.0.0) THEN
	    UTIL(77)=UTILUBER
...
C..DRIVE-ALONE PROBABILITIES
      ...
      ENDIF
      IF(ZEROCAR.AND.(C.LE.2).AND.(AV.EQ.1)) LSDA=0.0
C..2-PERSON DRIVE
      P2PROB(1)=1.0
      P2PROB(2)=0.0
      P2PROB(3)=0.0
...
C..MAAS 
      ...
      MAASPROB(2)=0.0
      LSMAAS=0.0
      DENOM=EUTIL(76)+EUTIL(77)
      IF(DENOM.GT.0.0) THEN
      LSMAAS=DLOG(DENOM)
      MAASPROB(2)=EUTIL(77)/DENOM
...
C....................................................................
     ...
     *               UTIL(76),EUTIL(76),MAASPROB(1),
     *               UTIL(77),EUTIL(77),MAASPROB(2)
...
C..P&R ACCESS - GO RAIL
      ...
      IF(C.LE.2.AND.ZEROCAR.AND.(AV.EQ.1)) DENOM=0.0
      IF(DENOM.GT.0.0) THEN
      LSCPR=DLOG(DENOM)
...
C..K&R ACCESS - GO RAIL
      ...
      END IF
C..UBER ACCESS - GO RAIL
      CUPROB(1)=1.0
      CUPROB(2)=0.0
      CUPROB(3)=0.0
      CUPROB(4)=0.0
      LSCUR=0.0
      DENOM=EUTIL(54)+EUTIL(55)+EUTIL(56)+EUTIL(57)
      IF(DENOM.GT.0.0) THEN
      LSCUR=DLOG(DENOM)
      CUPROB(1)=EUTIL(54)/DENOM
      CUPROB(2)=EUTIL(55)/DENOM
      CUPROB(3)=EUTIL(56)/DENOM
...
C....................................................................
     ...
     *               LSCWLK,LSCBUS,LSCPR,LSCKR,LSCUR
...
C...LOWER LEVEL K&R/UBER SPLIT
      ...
      UTIL(72)=LSUM4CU*LSCKR
      EUTIL(72)=EXP(UTIL(72))
      END IF
      IF(LSCUR.NE.0.0) THEN
      UTIL(73)=LSUM4CU*LSCUR
      ...
      IF(DENOM.GT.0.0) THEN
      LSCKR2=DLOG(DENOM)
      CUPROB(5)=EUTIL(72)/DENOM
      CUPROB(6)=1.0-CUPROB(5)
      END IF
C...KISS&RIDE ACCESS
      IF(LSCKR2.NE.0.0) THEN
      UTIL(30)=LSUM3CK*LSCKR2   +
...
C...UBER ACCESS FOR AIR PASSENGERS
     ...
     *              ACOEF(1),COSTUBER,ACCUBER,KWAIT)
      UTILUBER2=ACCUBER + ACOEF(3)*(COSTUBER*100.0)*LCPI +
     *         ACNST(11)
      EXPUBER2=EXP(UTILUBER2)
      END IF
C...PROBABILITIES
      CWPROB(3)=0.0
      CBPROB(3)=0.0
      ...
      IF(DENOM.GT.0.0) THEN
      IF(AIRPASS) DENOM=DENOM+EXPUBER2
      CWPROB(3)=EUTIL(27)/DENOM
      CBPROB(3)=EUTIL(28)/DENOM
      CPPROB(5)=EUTIL(29)/DENOM
      CUPROBAIR=EXPUBER2/DENOM
      CKPROB(5)=1.0-CWPROB(3)-CBPROB(3)-CPPROB(5)-CUPROBAIR
      CKPROB(5)=AMAX1(CKPROB(5),0.0)
      LSCR=DLOG(DENOM)
      END IF
C....................................................................
      IF(DEBUG) THEN
      WRITE(26,9009) (UTIL(K),EUTIL(K),K=72,73),
     *               (UTIL(K),EUTIL(K),K=27,30)
 9009 FORMAT(/1X,'SUMMARY OF GO RAIL ACCESS UTILITIES'/
     ...
     *       1X,'K&R  ACCESS TO GO RAIL ',F10.5,3X,E12.5)
      WRITE(26,9010) CUPROB(5),CUPROB(6),
     *               CWPROB(3),CBPROB(3),CPPROB(5),CKPROB(5),LSCR
...
C..K&R ACCESS - TTC SUBWAY
      ...
      END IF
C..UBER ACCESS - TTC SUBWAY
      UUPROB(1)=1.0
      UUPROB(2)=0.0
      UUPROB(3)=0.0
      UUPROB(4)=0.0
      LSUUR=0.0
      DENOM=EUTIL(58)+EUTIL(59)+EUTIL(60)+EUTIL(61)
      IF(DENOM.GT.0.0) THEN
      LSUUR=DLOG(DENOM)
      UUPROB(1)=EUTIL(58)/DENOM
      UUPROB(2)=EUTIL(59)/DENOM
      UUPROB(3)=EUTIL(60)/DENOM
...
C....................................................................
     ...
     *               LSUWLK,LSUBUS,LSUPR,LSUKR,LSUUR
...
C...LOWER LEVEL K&R/UBER SPLIT                              
      ...
      UTIL(74)=LSUM4UU*LSUKR                                
      EUTIL(74)=EXP(UTIL(74))                               
      END IF                                                
      IF(LSUUR.NE.0.0) THEN                                 
      UTIL(75)=LSUM4UU*LSUUR                                
      EUTIL(75)=EXP(UTIL(75))                               
      END IF                                                
      DENOM=EUTIL(74)+EUTIL(75)                             
      LSUKR2=0.0                                            
      IF(DENOM.GT.0.0) THEN                                 
      LSUKR2=DLOG(DENOM)                                    
      UUPROB(5)=EUTIL(74)/DENOM                             
      UUPROB(6)=1.0-UUPROB(5)                               
      END IF                                                
C...KISS&RIDE ACCESS                                        
      IF(LSUKR2.NE.0.0) THEN                                
      UTIL(34)=LSUM3UK*LSUKR2   +                           
...
C....................................................................
      IF(DEBUG) THEN
      WRITE(26,9109) (UTIL(K),EUTIL(K),K=74,75),
     *               (UTIL(K),EUTIL(K),K=31,34)
 9109 FORMAT(/1X,'SUMMARY OF TTC SUBWAY ACCESS UTILITIES'/
     ...
     *       1X,'UBER ACCESS TO TTC SUBWAY ',F10.5,3X,E12.5//
...
C
C ------------------------------------------------------------------
C CAR PROPENSITY LOOP
C    SEGMENTS:
C         1 = DRIVE ALONE CAPTIVE
C         2 = CARPOOL CAPTIVE
C         3 = FLEXIBLE (BOTH OPTIONS AVAILABLE)
C
      DO 1900 CP=cp1,cp3
C
C     COMPUTE SHARE OF PERSON TRIPS IN EACH CARPOOL
C     PROPENSITY SEGMENT
C
      IF(CP.EQ.1) THEN
      PROBCP=0.0
      UTILCP=0.0
      DENOM=0.0
      IF((ZDEN(IZ,1)+ZDEN(JZ,1)).GT.0) THEN
      ODEMPDEN=(ZDEN(IZ,3)+ZDEN(JZ,3))/(ZDEN(IZ,1)+ZDEN(JZ,1))/1000
      ELSE
      ODEMPDEN=0
      END IF
C
      DO CPX=1,3
        UTILCP(CPX)=KCP(CPX)+KCPMSEG(CPX,C)+KCPTPER(CPX)+
     *              COEFFCP(1+10*(CPX-1))*ZDEN(IZ,4) +
     *              COEFFCP(2+10*(CPX-1))*ZDEN(JZ,5) +
     *              COEFFCP(3+10*(CPX-1))*ODEMPDEN +
     *              COEFFCP(4+10*(CPX-1))*TTIME(JZ)
        IF(HOV_TOLDIST(JZ).GT.0) THEN
        UTILCP(CPX)=UTILCP(CPX)+COEFFCP(5+10*(CPX-1))
        END IF
        EUTILCP(CPX) = EXP(UTILCP(CPX))
        DENOM = DENOM + EUTILCP(CPX)
      END DO
C     ... FLEXIBLE MARKET ONLY IF CARPOOL PROPENSITY MODEL IS
C     ....UNSPECIFIED, INTRAZONAL IJ, OR AIR PASSENGER TRIP      
      IF(UTILCP(1).EQ.0.AND.UTILCP(2).EQ.0.AND.UTILCP(3).EQ.0) THEN
      PROBCP(3) = 1.0
      ELSE IF(IZ.EQ.JZ) THEN
      PROBCP(3) = 1.0
      ELSE IF(AIRPASS.AND.(.NOT.AIRTRN)) THEN
      PROBCP(3) = 1.0
      ELSE
      PROBCP(1) = EUTILCP(1)/DENOM
      PROBCP(2) = EUTILCP(2)/DENOM
      PROBCP(3) = 1-PROBCP(1)-PROBCP(2)
      END IF
C....................................................................
      IF(DEBUG) THEN
      WRITE(26,461) IEQUIV(IZ),IEQUIV(JZ),C,M,ZDEN(IZ,1),ZDEN(IZ,2),
     *              ZDEN(IZ,3),ZDEN(JZ,1),
     *              ZDEN(JZ,2),ZDEN(JZ,3),ZDEN(IZ,4),ZDEN(JZ,5),
     *              ODEMPDEN,
     *              TTIME(JZ),HOV_TOLDIST(JZ)
  461 FORMAT(/1X,'INPUTS TO CARPOOL PROPENSITY COMPUTATION'/,
     *       1X,'-----------------------------------------------'/
     *       5X,'PRODUCTION ZONE               = ',I8/
     *       5X,'ATTRACTION ZONE               = ',I8/
     *       5X,'HOUSEHOLD MARKET SEGMENT      = ',I8/ 
     *       5X,'ACCESS    MARKET SEGMENT      = ',I8/
     *       5X,'PRODUCTION ZONE AREA(KM2)     = ',F8.3/
     *       5X,'PRODUCTION ZONE POPULATION    = ',F8.0/
     *       5X,'PRODUCTION ZONE EMPLOYMENT    = ',F8.0/
     *       5X,'ATRACTION ZONE AREA(KM2)      = ',F8.3/
     *       5X,'ATRACTION ZONE POPULATION     = ',F8.0/
     *       5X,'ATRACTION ZONE EMPLOYMENT     = ',F8.0/
     *       5X,'PRODUCTION POPULATION DENSITY = ',F8.3/
     *       5X,'ATTRACTION EMPLOYMENT DENSITY = ',F8.3/
     *       5X,'EMPLOYMENT DENSITY            = ',F8.3/
     *       5X,'SOV TOLL TRAVEL TIME          = ',F8.3/
     *       5X,'DISTANCE TRAVELED ON HOV LANE = ',F8.3)
      WRITE(26,462) UTILCP(1),EUTILCP(1),PROBCP(1),
     *              KCP(1),KCPMSEG(1,C),KCPTPER(1),
     *              UTILCP(2),EUTILCP(2),PROBCP(2),
     *              KCP(2),KCPMSEG(2,C),KCPTPER(2),
     *              UTILCP(3),EUTILCP(3),PROBCP(3),
     *              KCP(3),KCPMSEG(3,C),KCPTPER(3)
  462 FORMAT(/1X,'CARPOOL PROPENSITY PERSON TRIP MARKET SHARES'/
     *       1X,'-----------------------------------------------'/
     *       1X,'                   ',6X,'UTIL',10X,'EUTIL',10X,'PROB',
     *       6X,'  KCP   ',2X,' KCPMSEG',2X,' KCPTPER'/
     *       1X,'                   ',3X,'----------',5X,
     *          '----------',5X,'----------',3(2X,'--------')/
     *       1X,'SOV CAPTIVE           ',F10.5,3X,E13.6,3X,F10.2,
     *       3(2X,F8.3)/
     *       1X,'HOV CAPTIVE           ',F10.5,3X,E13.6,3X,F10.2,
     *       3(2X,F8.3)/
     *       1X,'FLEXIBLE              ',F10.5,3X,E13.6,3X,F10.2,
     *       3(2X,F8.3))
      END IF
C....................................................................
      ELSEIF(.NOT.CARPOOL) THEN
      PROBCP(3)=1.0
      END IF
C
...
C ..DRIVE-ALONE UTILITY
      IF(LSDA.NE.0.0.AND.CP.NE.2) THEN
...
C..SHARED RIDE UTILITY
      IF(LSSHR.NE.0.0.AND.CP.NE.1) THEN
...
C....................................................................
      IF(DEBUG) THEN
      WRITE(26,9115) CP,CPSEG(CP),C,
     *               UTIL(67),EUTIL(67),UTIL(68),EUTIL(68)
 9115 FORMAT(/1X,'SUMMARY OF AUTO SUBMODE UTILITIES'//
     *       1X,'CARPOOL PROPENSITY SEGMENT = ',I4,1X,A20,/
     *       1X,'HOUSEHOLD MARKET           = ',I1/
     *       1X,'-----------------------------------'/
     *       1X,'                     ',6X,'UTIL',10X,'EUTIL'/
     *       1X,'                     ',3X,'----------',5X,
     *          '----------'/
...
C..MAAS
      ...
      UTIL(78)=LSUM1AUTO*LSMAAS + KMAAS(C)
      EUTIL(78)=EXP(UTIL(78))
      END IF
C..NON-TRANSIT EXPOENTIATED UTILITY FOR FTA USERBEN FILE
      AUTEXP=EUTIL(69)+EUTIL(71)+EUTIL(78)
C..PROBABILITIES
      MOTOR=0.0
      LSMOT=0.0
      DENOM=EUTIL(69)+EUTIL(70)+EUTIL(71)+EUTIL(78)
      IF(DENOM.GT.0.0) THEN
      LSMOT=DLOG(DENOM)
      MOTOR(4)=EUTIL(78)/DENOM
      MOTOR(2)=EUTIL(70)/DENOM
      MOTOR(3)=EUTIL(71)/DENOM
      MOTOR(1)=1.0-MOTOR(2)-MOTOR(3)-MOTOR(4)
...
C....................................................................
 ...
 9017 FORMAT(/1X,'SUMMARY OF BASIC UTILITIES'/
     ...
     *       1X,'MAAS                    ',F10.5,3X,E13.6)       
      WRITE(26,9018) MOTOR(1),MOTOR(2),MOTOR(3),MOTOR(4),
     *               LSMOT,C,ULOGSUM(C),FSHAR(1),FSHAR(2)
...
C
      PERTRPCP=PERTRP*PROBCP(CP)      
      TSCHBUS=PERTRPCP*SCHBUS
      TMOTOR=PERTRPCP-TSCHBUS
      TTRAN=TMOTOR*MOTOR(2)
      TNMOT=TMOTOR*MOTOR(3)
      TMAAS=TMOTOR*MOTOR(4)
      TAUTO=TMOTOR-TTRAN-TNMOT-TMAAS
C
C   AIR PASSENGER TRIP MATRIX VALUES
C
      IF(AIRPASS.AND.(.NOT.AIRTRN)) THEN
C     IF((.NOT.AIRTRN)) THEN
      PERTRPCP=PERTRPCP*AIRFCTR
      TNMOT=0.0
      TSCHBUS=0.0
      TTRAN=PERTRPCP*PROBAIR(9)*PROBAIR(7)
      TDROP=PERTRPCP*PROBAIR(10)*PROBAIR(4)
      TLIMO=PERTRPCP*PROBAIR(10)*PROBAIR(3)
      TRNTL=PERTRPCP*PROBAIR(10)*PROBAIR(2)
      TTAXIAIR=PERTRPCP*PROBAIR(10)*PROBAIR(1)
      TAUTO=PERTRPCP*PROBAIR(10)*PROBAIR(5)
      TUBERAIR=PERTRPCP*PROBAIR(10)*PROBAIR(8)
      TONCL=PERTRPCP-TTRAN-TDROP-TLIMO-TRNTL-TTAXIAIR-TAUTO-TUBERAIR    
C ---------------------------------------------------------
      IF(LDEBUG) THEN
      WRITE(26,452) IEQUIV(IZ),IEQUIV(JZ),
     *              PERTRPCP,TTRAN,TDROP,TLIMO,TRNTL,TTAXIAIR,
     *              TAUTO,TONCL,TUBERAIR
...
C
      ...
      TTAXI=0.0
      TUBER=0.0
      TSCHBUS=PERTRPCP*INTRASCHBUS(C)
      TDRV2NN=PERTRPCP*INTRA2P(C)
      TDRV3NN=PERTRPCP*INTRA3P(C)
      IF(NMOT) THEN
      TNMBK=PERTRPCP*INTRABIKE(C)
      TNMWK=PERTRPCP*INTRAWLK(C)
      TNMOT=TNMBK+TNMWK
      ELSE
      TNMBK=0.0
      TNMWK=0.0
      TNMOT=0.0
      END IF
      TDRV0N=PERTRPCP-TNMWK-TDRV2NN-TDRV3NN-TNMBK-TSCHBUS
...
C....................................................................
      IF(DEBUG) THEN
      WRITE(26,9421) C,M,CP,AV,AVCV,PROBCP(CP),ZHHD(AVCV,IZ),PERTRPCP,
     *               TTRAN,TAUTO,TNMOT,TCR,TUR,TGB,
     *               TSTR,TRPD,TGBW,TGBD,TSTRW,TSTRD,TRPDW,TRPDD,
     *               TCRW,TCRB,TCRP,TCRK,TCRU,TCRW1,TCRW2,
     *               TCRB1,TCRB2,
     *               TCRP1,TCRP2,TCRP3,TCRP4,
     *               TCRK1,TCRK2,TCRK3,TCRK4,
     *               TCRU1,TCRU2,TCRU3,TCRU4,
     *               TURW,TURB,TURP,TURK,TURU,TURW1,TURW2,
     *               TURB1,TURB2,
     ...
     *               TNMWK,TNMBK,TTAXI,TUBER
 9421 FORMAT(/1X,'SUMMARY OF MODAL TRIP VALUES'/
     *       1X,'-----------------------------------'/
     *       1X,'MARKET SEGMENT                 =',I2/
     *       1X,'ACCESS SEGMENT                 =',I2/
     *       1X,'CARPOOL PROPENSITY SEGMENT     =',I2/
     *       1X,'AV/CV MARKET SEGMENT           =',I2/
     *       1X,'AV/CV INDEX VALUE              =',I2/
     *       1X,'PROPENSITY SEGMENT PROPORTION  =',F10.5/
     *       1X,'AV/CV PROPORTION               =',F10.5//
     ...
     *       1X,'GO RAIL       KNR   -STATION #1=',F10.5/
     *       1X,'GO RAIL       KNR   -STATION #2=',F10.5/
     *       1X,'GO RAIL       KNR   -STATION #3=',F10.5/
     *       1X,'GO RAIL       KNR   -STATION #4=',F10.5/
     *       1X,'GO RAIL       UBER  -STATION #1=',F10.5/
     *       1X,'GO RAIL       UBER  -STATION #2=',F10.5/
     *       1X,'GO RAIL       UBER  -STATION #3=',F10.5/
     *       1X,'GO RAIL       UBER  -STATION #4=',F10.5//
     *       1X,'WALK  --> TTC SUBWAY           =',F10.5/
     *       1X,'BUS   --> TTC SUBWAY           =',F10.5/
     *       1X,'P&R   --> TTC SUBWAY           =',F10.5/
     *       1X,'K&R   --> TTC SUBWAY           =',F10.5/
     *       1X,'UBER  --> TTC SUBWAY           =',F10.5//
     ...
     *       1X,'TTC SUBWAY    UBER  -STATION #1=',F10.5/
     *       1X,'TTC SUBWAY    UBER  -STATION #2=',F10.5/
     *       1X,'TTC SUBWAY    UBER  -STATION #3=',F10.5/
     *       1X,'TTC SUBWAY    UBER  -STATION #4=',F10.5//
...
C....................................................................
      IF(TRESO) THEN
      INDEX=(C-1)*4+AV
      TRESODAT(1,INDEX)=TRESODAT(1,INDEX)+TDRV0N
      TRESODAT(2,INDEX)=TRESODAT(2,INDEX)+TDRV0T
      TRESODAT(3,INDEX)=TRESODAT(3,INDEX)+TDRV2NH
      TRESODAT(4,INDEX)=TRESODAT(4,INDEX)+TDRV2NN
      TRESODAT(5,INDEX)=TRESODAT(5,INDEX)+TDRV2TH
      TRESODAT(6,INDEX)=TRESODAT(6,INDEX)+TDRV2TN
      TRESODAT(7,INDEX)=TRESODAT(7,INDEX)+TDRV3NH
      TRESODAT(8,INDEX)=TRESODAT(8,INDEX)+TDRV3NN
      TRESODAT(9,INDEX)=TRESODAT(9,INDEX)+TDRV3TH
      TRESODAT(10,INDEX)=TRESODAT(10,INDEX)+TDRV3TN
      TRESODAT(11,INDEX)=TRESODAT(11,INDEX)+TNMWK
      TRESODAT(12,INDEX)=TRESODAT(12,INDEX)+TNMBK
      TRESODAT(13,INDEX)=TRESODAT(13,INDEX)+TTAXI
      TRESODAT(14,INDEX)=TRESODAT(14,INDEX)+TUBER
      TRESODAT(15,INDEX)=TRESODAT(15,INDEX)+TGBW
      TRESODAT(16,INDEX)=TRESODAT(16,INDEX)+TGBD
      TRESODAT(17,INDEX)=TRESODAT(17,INDEX)+TSTRW
      TRESODAT(18,INDEX)=TRESODAT(18,INDEX)+TSTRB
      TRESODAT(19,INDEX)=TRESODAT(19,INDEX)+TRPDW
      TRESODAT(20,INDEX)=TRESODAT(20,INDEX)+TRPDD
C
      TRESODAT(21,INDEX)=TRESODAT(21,INDEX)+TCRW1
      TRESODAT(22,INDEX)=TRESODAT(22,INDEX)+TCRW2
      TRESODAT(23,INDEX)=TRESODAT(23,INDEX)+TCRB1
      TRESODAT(24,INDEX)=TRESODAT(24,INDEX)+TCRB2
      TRESODAT(25,INDEX)=TRESODAT(25,INDEX)+TCRP1
      TRESODAT(26,INDEX)=TRESODAT(26,INDEX)+TCRP2
      TRESODAT(27,INDEX)=TRESODAT(27,INDEX)+TCRP3
      TRESODAT(28,INDEX)=TRESODAT(28,INDEX)+TCRP4
      TRESODAT(29,INDEX)=TRESODAT(29,INDEX)+TCRK1
      TRESODAT(30,INDEX)=TRESODAT(30,INDEX)+TCRK2
      TRESODAT(31,INDEX)=TRESODAT(31,INDEX)+TCRK3
      TRESODAT(32,INDEX)=TRESODAT(32,INDEX)+TCRK4
      TRESODAT(33,INDEX)=TRESODAT(33,INDEX)+TCRU1
      TRESODAT(34,INDEX)=TRESODAT(34,INDEX)+TCRU2
      TRESODAT(35,INDEX)=TRESODAT(35,INDEX)+TCRU3
      TRESODAT(36,INDEX)=TRESODAT(36,INDEX)+TCRU4
C
      TRESODAT(37,INDEX)=TRESODAT(37,INDEX)+TURW1
      TRESODAT(38,INDEX)=TRESODAT(38,INDEX)+TURW2
      TRESODAT(39,INDEX)=TRESODAT(39,INDEX)+TURB1
      TRESODAT(40,INDEX)=TRESODAT(40,INDEX)+TURB2
      TRESODAT(41,INDEX)=TRESODAT(41,INDEX)+TURP1
      TRESODAT(42,INDEX)=TRESODAT(42,INDEX)+TURP2
      TRESODAT(43,INDEX)=TRESODAT(43,INDEX)+TURP3
      TRESODAT(44,INDEX)=TRESODAT(44,INDEX)+TURP4
      TRESODAT(45,INDEX)=TRESODAT(45,INDEX)+TURK1
      TRESODAT(46,INDEX)=TRESODAT(46,INDEX)+TURK2
      TRESODAT(47,INDEX)=TRESODAT(47,INDEX)+TURK3
      TRESODAT(48,INDEX)=TRESODAT(48,INDEX)+TURK4
      TRESODAT(49,INDEX)=TRESODAT(49,INDEX)+TURU1
      TRESODAT(50,INDEX)=TRESODAT(50,INDEX)+TURU2
      TRESODAT(51,INDEX)=TRESODAT(51,INDEX)+TURU3
      TRESODAT(52,INDEX)=TRESODAT(52,INDEX)+TURU4
C....................................................................
      IF(DEBUG) THEN
      WRITE(26,9491) C,AV,INDEX,M,CP,PROBCP(CP),PERTRPCP,
     *               (TRESODAT(K,INDEX),K=1,52)
 9491 FORMAT(/1X,'SUMMARY OF TRESO OUTPUT TRIP VALUES'/
     *       1X,'------------------------------------'/
     *       1X,'MARKET SEGMENT                =',I2/
     *       1X,'AV/CV  SEGMENT                =',I2/
     *       1X,'COMPUTED INDEX                =',I2/
     *       1X,'ACCESS SEGMENT                =',I2/
     *       1X,'CARPOOL PROPENSITY SEGMENT    =',I2//
     *       1X,'PROPENSITY SEGMENT PROPORTION =',F10.5/
     *       1X,'PERSON TRIPS                  =',F10.5/
...
C..UPPER LEVEL
      ...
      TESUM(41,C)=TESUM(41,C) + TTAXI
      IF(UBERAV(AV).EQ.0) THEN
      TESUM(42,C)=TESUM(42,C) + TUBER
      ELSE
      TESUM(57,C)=TESUM(57,C) + TUBER
      END IF
      TESUM(43,C)=TESUM(43,C) + TTAXI+TUBER
...
C....AUTOMATED VEHICLE SUMMARY
      ELSE
      TESUM(47,C)=TESUM(47,C) + TDRV0N
      TESUM(48,C)=TESUM(48,C) + TDRV0T
      TESUM(50,C)=TESUM(50,C) + TDRV2NH
      TESUM(49,C)=TESUM(49,C) + TDRV2NN
      TESUM(52,C)=TESUM(52,C) + TDRV2TH
      TESUM(51,C)=TESUM(51,C) + TDRV2TN
      TESUM(54,C)=TESUM(54,C) + TDRV3NH
      TESUM(53,C)=TESUM(53,C) + TDRV3NN
      TESUM(56,C)=TESUM(56,C) + TDRV3TH
      TESUM(55,C)=TESUM(55,C) + TDRV3TN
      END IF
C...PARKING LOCATION
      IF(HHLDAV(AV).EQ.1) THEN
      TESUM(44,C)=TESUM(44,C) + TAUTO*PROBWRK
      IF(HOMEAV) THEN
      TESUM(45,C)=TESUM(45,C) + TAUTO*PROBOTH
      ELSE
      TESUM(46,C)=TESUM(46,C) + TAUTO*PROBOTH
      END IF
      END IF
C...NON-MOTORIZED
...
C...TRANSIT BY TRIP LENGTH
     ...
     *   PTRIP(PINDEX,C)=PTRIP(PINDEX,C)+PERTRPCP
C...TAXI WAIT TIME DISTRIBUTION
      YINDEX=IFIX(TXWAIT)
      IF(YINDEX.LE.0) YINDEX=1
      IF(YINDEX.GT.100) YINDEX=100   
      TAXIWAIT(YINDEX,ZINDEX)=TAXIWAIT(YINDEX,ZINDEX)+TTAXI
      TAXIWAIT(YINDEX,7)=TAXIWAIT(YINDEX,7)+TTAXI
C...TAXI TRIP LENGTH FREQUENCY DISTRIBUTION
      YINDEX=IFIX(HDIST(JZ)*10.0)+1
      YINDEX=IMIN0(YINDEX,1001)
      TAXITLF(YINDEX)=TAXITLF(YINDEX)+TTAXI
C...DISTRICT LEVEL SUMMARIES
      IF(DIZ.LE.0.OR.DIZ.GT.60.OR.DJZ.LE.0.OR.DJZ.GT.60) THEN
 ...
 8030 FORMAT(' PTAZ=',I5,' DIZ=',I3,' ATAZ=',I5,' DJZ=',I3)
      ...
      TOTTRN(31,DJZ,1)=TOTTRN(31,DJZ,1)+TTRAN
      TOTTRN(DIZ,31,1)=TOTTRN(DIZ,31,1)+TTRAN
      TOTTRN(31,31,1)=TOTTRN(31,31,1)+TTRAN
      TOTTRN(DIZ,DJZ,2)=TOTTRN(DIZ,DJZ,2)+TCR
      TOTTRN(31,DJZ,2)=TOTTRN(31,DJZ,2)+TCR
      TOTTRN(DIZ,31,2)=TOTTRN(DIZ,31,2)+TCR
      TOTTRN(31,31,2)=TOTTRN(31,31,2)+TCR
      TOTTRN(DIZ,DJZ,3)=TOTTRN(DIZ,DJZ,3)+TUR
      TOTTRN(31,DJZ,3)=TOTTRN(31,DJZ,3)+TUR
      TOTTRN(DIZ,31,3)=TOTTRN(DIZ,31,3)+TUR
      TOTTRN(31,31,3)=TOTTRN(31,31,3)+TUR
      TOTTRN(DIZ,DJZ,4)=TOTTRN(DIZ,DJZ,4)+TGB
      TOTTRN(31,DJZ,4)=TOTTRN(31,DJZ,4)+TGB
      TOTTRN(DIZ,31,4)=TOTTRN(DIZ,31,4)+TGB
      TOTTRN(31,31,4)=TOTTRN(31,31,4)+TGB
      TOTTRN(DIZ,DJZ,5)=TOTTRN(DIZ,DJZ,5)+TSTR
      TOTTRN(31,DJZ,5)=TOTTRN(31,DJZ,5)+TSTR
      TOTTRN(DIZ,31,5)=TOTTRN(DIZ,31,5)+TSTR
      TOTTRN(31,31,5)=TOTTRN(31,31,5)+TSTR
      TOTTRN(DIZ,DJZ,6)=TOTTRN(DIZ,DJZ,6)+TRPD
      TOTTRN(31,DJZ,6)=TOTTRN(31,DJZ,6)+TRPD
      TOTTRN(DIZ,31,6)=TOTTRN(DIZ,31,6)+TRPD
      TOTTRN(31,31,6)=TOTTRN(31,31,6)+TRPD
C
      TOTAUT(DIZ,DJZ,1)=TOTAUT(DIZ,DJZ,1)+TAUTO
      TOTAUT(31,DJZ,1)=TOTAUT(31,DJZ,1)+TAUTO
      TOTAUT(DIZ,31,1)=TOTAUT(DIZ,31,1)+TAUTO
      TOTAUT(31,31,1)=TOTAUT(31,31,1)+TAUTO
      TOTAUT(DIZ,DJZ,2)=TOTAUT(DIZ,DJZ,2)+TDRV0
      TOTAUT(31,DJZ,2)=TOTAUT(31,DJZ,2)+TDRV0
      TOTAUT(DIZ,31,2)=TOTAUT(DIZ,31,2)+TDRV0
      TOTAUT(31,31,2)=TOTAUT(31,31,2)+TDRV0
      TOTAUT(DIZ,DJZ,3)=TOTAUT(DIZ,DJZ,3)+TDRV2
      TOTAUT(31,DJZ,3)=TOTAUT(31,DJZ,3)+TDRV2
      TOTAUT(DIZ,31,3)=TOTAUT(DIZ,31,3)+TDRV2
      TOTAUT(31,31,3)=TOTAUT(31,31,3)+TDRV2
      TOTAUT(DIZ,DJZ,4)=TOTAUT(DIZ,DJZ,4)+TDRV3
      TOTAUT(31,DJZ,4)=TOTAUT(31,DJZ,4)+TDRV3
      TOTAUT(DIZ,31,4)=TOTAUT(DIZ,31,4)+TDRV3
      TOTAUT(31,31,4)=TOTAUT(31,31,4)+TDRV3
C
       IF(TUR.GT.0) THEN
       AVLTTC(DIZ,DJZ,1)=AVLTTC(DIZ,DJZ,1)+PERTRPCP
       AVLTTC(31,DJZ,1)=AVLTTC(31,DJZ,1)+PERTRPCP
       AVLTTC(DIZ,31,1)=AVLTTC(DIZ,31,1)+PERTRPCP
       AVLTTC(31,31,1)=AVLTTC(31,31,1)+PERTRPCP
       END IF
       IF(TSTR.GT.0) THEN
       AVLTTC(DIZ,DJZ,2)=AVLTTC(DIZ,DJZ,2)+PERTRPCP
       AVLTTC(31,DJZ,2)=AVLTTC(31,DJZ,2)+PERTRPCP
       AVLTTC(DIZ,31,2)=AVLTTC(DIZ,31,2)+PERTRPCP
       AVLTTC(31,31,2)=AVLTTC(31,31,2)+PERTRPCP
       END IF
C...NON MOTORIZED
      NONMOT(DIZ,DJZ,1)=NONMOT(DIZ,DJZ,1)+TNMWK
      NONMOT(31,DJZ,1)=NONMOT(31,DJZ,1)+TNMWK
      NONMOT(DIZ,31,1)=NONMOT(DIZ,31,1)+TNMWK
      NONMOT(31,31,1)=NONMOT(31,31,1)+TNMWK
      NONMOT(DIZ,DJZ,2)=NONMOT(DIZ,DJZ,2)+TNMBK
      NONMOT(31,DJZ,2)=NONMOT(31,DJZ,2)+TNMBK
      NONMOT(DIZ,31,2)=NONMOT(DIZ,31,2)+TNMBK
      NONMOT(31,31,2)=NONMOT(31,31,2)+TNMBK
      NONMOT(DIZ,DJZ,3)=NONMOT(DIZ,DJZ,3)+TNMBK+TNMWK
      NONMOT(31,DJZ,3)=NONMOT(31,DJZ,3)+TNMBK+TNMWK
      NONMOT(DIZ,31,3)=NONMOT(DIZ,31,3)+TNMBK+TNMWK
      NONMOT(31,31,3)=NONMOT(31,31,3)+TNMBK+TNMWK
      END IF
C...TAXI
      TAXISUM(DIZ,DJZ)=TAXISUM(DIZ,DJZ)+TTAXI
      TAXISUM(31,DJZ)=TAXISUM(31,DJZ)+TTAXI
      TAXISUM(DIZ,31)=TAXISUM(DIZ,31)+TTAXI
      TAXISUM(31,31)=TAXISUM(31,31)+TTAXI
C
...
C...GO BUS WALK ACCESS IN-VEHICLE RATIO
      IST=1
      IF(INVEH(JZ).GT.0.0) 
     *   IST=IFIX(((INVEHG(JZ)+INVEHP(JZ))/INVEH(JZ))*100.0)+1
      IST=MIN0(IST,101)
      GBUSRAT(IST,1)=GBUSRAT(IST,1)+TGBW
C...GO BUS DRIVE ACCESS IN-VEHICLE RATIO
      IT=CSTAT-MAX_IZONES
      IF(IT.GT.0) THEN
      IST=IFIX(STAZNE(7,IT,JZ)*100.0)+1
      IST=MIN0(IST,101)
      GBUSRAT(IST,2)=GBUSRAT(IST,2)+TGBD
      END IF
...
C
C  HIGHWAY RELIABILITY FREQUENCY DISTRIBUTION
C
      IF(HWYREL) THEN
      INDEX=IFIX(HTREL(JZ))+2
      IF(HTREL(JZ).LE.0.0) INDEX=1
      HTRELTLF(INDEX,1)=HTRELTLF(INDEX,1)+TDRV0N
      HTRELTLF(INDEX,2)=HTRELTLF(INDEX,2)+TDRV2NN      
      HTRELTLF(INDEX,3)=HTRELTLF(INDEX,3)+TDRV3NN
      INDEX=IFIX((HTREL(JZ)/HTIME(JZ))*10.0)+2
      IF(HTREL(JZ).LE.0.0) INDEX=1
      IF(INDEX.GT.52) INDEX=52
      HTRELRAT(INDEX,1)=HTRELRAT(INDEX,1)+TDRV0N
      HTRELRAT(INDEX,2)=HTRELRAT(INDEX,2)+TDRV2NN      
      HTRELRAT(INDEX,3)=HTRELRAT(INDEX,3)+TDRV3NN  
      INDEX=IFIX(TOLTREL(JZ))+2
      IF(TOLTREL(JZ).LE.0.0) INDEX=1
      TOLTRELF(INDEX)=TOLTRELF(INDEX)+TDRV0T
      INDEX=IFIX(TREL2P(JZ))+2
      IF(TREL2P(JZ).LE.0.0) INDEX=1
      TREL2PTLF(INDEX,1)=TREL2PTLF(INDEX,1)+TDRV2NH
      TREL2PTLF(INDEX,2)=TREL2PTLF(INDEX,2)+TDRV3NH     
      INDEX=IFIX(TOLTREL2P(JZ))+2
      IF(TOLTREL2P(JZ).LE.0.0) INDEX=1
      TOLTREL2PTLF(INDEX,1)=TOLTREL2PTLF(INDEX,1)+TDRV2TH
      TOLTREL2PTLF(INDEX,2)=TOLTREL2PTLF(INDEX,2)+TDRV2TN  
      TOLTREL2PTLF(INDEX,3)=TOLTREL2PTLF(INDEX,3)+TDRV3TH
      TOLTREL2PTLF(INDEX,4)=TOLTREL2PTLF(INDEX,4)+TDRV3TN      
      END IF
C
...
C..AUTO
      AUTTRP(JZ,11)=AUTTRP(JZ,11)+TTAXI
      IF(HHLDAV(AV).EQ.0) THEN
      ...
      ELSE
      AUTTRP(JZ,13)=AUTTRP(JZ,13)+TDRV0N
      AUTTRP(JZ,14)=AUTTRP(JZ,14)+TDRV0T
      AUTTRP(JZ,15)=AUTTRP(JZ,15)+TDRV2NH
      AUTTRP(JZ,16)=AUTTRP(JZ,16)+TDRV2NN
      AUTTRP(JZ,17)=AUTTRP(JZ,17)+TDRV2TH
      AUTTRP(JZ,18)=AUTTRP(JZ,18)+TDRV2TN
      AUTTRP(JZ,19)=AUTTRP(JZ,19)+TDRV3NH
      AUTTRP(JZ,20)=AUTTRP(JZ,20)+TDRV3NN
      AUTTRP(JZ,21)=AUTTRP(JZ,21)+TDRV3TH
      AUTTRP(JZ,22)=AUTTRP(JZ,22)+TDRV3TN
      END IF
      IF(UBERAV(AV).EQ.0) THEN
      AUTTRP(JZ,12)=AUTTRP(JZ,12)+TUBER
      ELSE
      AUTTRP(JZ,23)=AUTTRP(JZ,23)+TUBER            
      END IF
C
...
C...........................................................
      ...
      PRINTZN=0
      IF(APRKZONE(JZ).GT.0) PRINTZN=IEQUIV(APRKZONE(JZ))
      WRITE(26,9625) TDRV0,TDRV2,TDRV3,PROBOTH,
     *               HOMEAV,PRINTZN
...
C............................................................
      ...
      END IF
C
C     PARKING MODEL AUTO PERSON DATA
C
      VEHATTR(JZ,1)=VEHATTR(JZ,1)+TDRV0N
      VEHATTR(JZ,2)=VEHATTR(JZ,2)+TDRV0T
      VEHATTR(JZ,3)=VEHATTR(JZ,3)+TDRV2NH
      VEHATTR(JZ,4)=VEHATTR(JZ,4)+TDRV2NN
      VEHATTR(JZ,5)=VEHATTR(JZ,5)+TDRV2TH
      VEHATTR(JZ,6)=VEHATTR(JZ,6)+TDRV2TN
      VEHATTR(JZ,7)=VEHATTR(JZ,7)+TDRV3NH
      VEHATTR(JZ,8)=VEHATTR(JZ,8)+TDRV3NN
      VEHATTR(JZ,9)=VEHATTR(JZ,9)+TDRV3TH
      VEHATTR(JZ,10)=VEHATTR(JZ,10)+TDRV3TN
      VEHATTR(JZ,11)=VEHATTR(JZ,11)+PERTRPCP
C
...
C
   ...
   43 CONTINUE
      END IF
C
C..GO RAIL STATION ACCESS SUMMARY MATRIX
     ...
     *                    STASUM((OSTA(1,12)-MAX_IZONES),4)+TCRK4
      STASUM((OSTA(1,9)-MAX_IZONES),12)=
     *                   STASUM((OSTA(1,9)-MAX_IZONES),12)+TCRU1
      STASUM((OSTA(1,10)-MAX_IZONES),12)=
     *                    STASUM((OSTA(1,10)-MAX_IZONES),12)+TCRU2
      STASUM((OSTA(1,11)-MAX_IZONES),12)=
     *                    STASUM((OSTA(1,11)-MAX_IZONES),12)+TCRU3
      STASUM((OSTA(1,12)-MAX_IZONES),12)=
     *                    STASUM((OSTA(1,12)-MAX_IZONES),12)+TCRU4
...
C..GO RAIL STATION EGRESS SUMMARY MATRIX
     ...
     *   STASUM2((ASTA(1,9)-MAX_IZONES),ASTA2(1,9))+TCRK1+TCRU1
      STASUM2((ASTA(1,10)-MAX_IZONES),ASTA2(1,10))=
     *   STASUM2((ASTA(1,10)-MAX_IZONES),ASTA2(1,10))+TCRK2+TCRU2
      STASUM2((ASTA(1,11)-MAX_IZONES),ASTA2(1,11))=
     *   STASUM2((ASTA(1,11)-MAX_IZONES),ASTA2(1,11))+TCRK3+TCRU3
      STASUM2((ASTA(1,12)-MAX_IZONES),ASTA2(1,12))=
     *   STASUM2((ASTA(1,12)-MAX_IZONES),ASTA2(1,12))+TCRK4+TCRU4
      ELSE
      IMODE=1
      CALL SUMSTA(IMODE,JZ,ASTA(1,1),TCRW1,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA(1,2),TCRW2,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA(1,3),TCRB1,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK)   
      CALL SUMSTA(IMODE,JZ,ASTA(1,4),TCRB2,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA(1,5),TCRP1,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK)  
      CALL SUMSTA(IMODE,JZ,ASTA(1,6),TCRP2,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA(1,7),TCRP3,STASUM2,STAEGR,STASUM3,  
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA(1,8),TCRP4,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA(1,9),TCRK1,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA(1,9),TCRU1,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK)   
      CALL SUMSTA(IMODE,JZ,ASTA(1,10),TCRK2,STASUM2,STAEGR,STASUM3,  
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA(1,10),TCRU2,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA(1,11),TCRK3,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA(1,11),TCRU3,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK)  
      CALL SUMSTA(IMODE,JZ,ASTA(1,12),TCRK4,STASUM2,STAEGR,STASUM3,  
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA(1,12),TCRU4,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK)         
      END IF
      IF(EQUIV(PEARSON).GT.0) THEN
      Stasum5((EQUIV(PEARSON)-MAX_IZONES),2)=
     *                    STASUM5((EQUIV(PEARSON)-MAX_IZONES),2)+
     *                    TUBERACC
      END IF
C..URBAN RAIL STATION ACCESS SUMMARY MATRIX FOR EGRESS FROM GO RAIL TRIPS
     ...
     *      STASUM3((OSTA3(1,9)-MAX_IZONES),1)+ TCRK1+TCRU1
      STASUM3((OSTA3(1,10)-MAX_IZONES),1)=
     *      STASUM3((OSTA3(1,10)-MAX_IZONES),1)+TCRK2+TCRU2
      STASUM3((OSTA3(1,11)-MAX_IZONES),1)=
     *      STASUM3((OSTA3(1,11)-MAX_IZONES),1)+TCRK3+TCRU3
      STASUM3((OSTA3(1,12)-MAX_IZONES),1)=
     *      STASUM3((OSTA3(1,12)-MAX_IZONES),1)+TCRK4+TCRU4
C..URBAN RAIL STATION EGRESS SUMMARY MATRIX FOR EGRESS FROM GO RAIL TRIPS
     ...
     *   STASUM3((ASTA3(1,9)-MAX_IZONES),2)+TCRK1+TCRU1
      STASUM3((ASTA3(1,10)-MAX_IZONES),2)=
     *   STASUM3((ASTA3(1,10)-MAX_IZONES),2)+TCRK2+TCRU2
      STASUM3((ASTA3(1,11)-MAX_IZONES),2)=
     *   STASUM3((ASTA3(1,11)-MAX_IZONES),2)+TCRK3+TCRU3
      STASUM3((ASTA3(1,12)-MAX_IZONES),2)=
     *   STASUM3((ASTA3(1,12)-MAX_IZONES),2)+TCRK4+TCRU4
      ELSE
      IMODE=3
      CALL SUMSTA(IMODE,JZ,ASTA3(1,1),TCRW1,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA3(1,2),TCRW2,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK)  
      CALL SUMSTA(IMODE,JZ,ASTA3(1,3),TCRB1,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK)  
      CALL SUMSTA(IMODE,JZ,ASTA3(1,4),TCRB2,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA3(1,5),TCRP1,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA3(1,6),TCRP2,STASUM2,STAEGR,STASUM3,  
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA3(1,7),TCRP3,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK)  
      CALL SUMSTA(IMODE,JZ,ASTA3(1,8),TCRP4,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA3(1,9),TCRK1,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA3(1,9),TCRU1,STASUM2,STAEGR,STASUM3,  
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA3(1,10),TCRK2,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK)  
      CALL SUMSTA(IMODE,JZ,ASTA3(1,10),TCRU2,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA3(1,11),TCRK3,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA3(1,11),TCRU3,STASUM2,STAEGR,STASUM3,  
     *            DIRWALK,EGRWALK) 
      CALL SUMSTA(IMODE,JZ,ASTA3(1,12),TCRK4,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK)   
      CALL SUMSTA(IMODE,JZ,ASTA3(1,12),TCRU4,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK)           
      END IF
...
C..TTC SUBWAY STATION SUMMARY MATRIX
     ...
     *                    STASUM((OSTA(2,12)-MAX_IZONES),9)+TURK4
      STASUM((OSTA(2,9)-MAX_IZONES),13)=
     *                    STASUM((OSTA(2,9)-MAX_IZONES),13)+TURU1
      STASUM((OSTA(2,10)-MAX_IZONES),13)=
     *                    STASUM((OSTA(2,10)-MAX_IZONES),13)+TURU2
      STASUM((OSTA(2,11)-MAX_IZONES),13)=
     *                    STASUM((OSTA(2,11)-MAX_IZONES),13)+TURU3
      STASUM((OSTA(2,12)-MAX_IZONES),13)=
     *                    STASUM((OSTA(2,12)-MAX_IZONES),13)+TURU4
C..TTC SUBWAY STATION EGRESS SUMMARY MATRIX
     ...
     *   STASUM2((ASTA(2,9)-MAX_IZONES),ASTA2(2,9))+TURK1+TURU1
      STASUM2((ASTA(2,10)-MAX_IZONES),ASTA2(2,10))=
     *   STASUM2((ASTA(2,10)-MAX_IZONES),ASTA2(2,10))+TURK2+TURU2
      STASUM2((ASTA(2,11)-MAX_IZONES),ASTA2(2,11))=
     *   STASUM2((ASTA(2,11)-MAX_IZONES),ASTA2(2,11))+TURK3+TURU3
      STASUM2((ASTA(2,12)-MAX_IZONES),ASTA2(2,12))=
     *   STASUM2((ASTA(2,12)-MAX_IZONES),ASTA2(2,12))+TURK4+TURU4
      ELSE
      IMODE=2
      CALL SUMSTA(IMODE,JZ,ASTA(2,1),TURW1,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK)   
      CALL SUMSTA(IMODE,JZ,ASTA(2,2),TURW2,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK)    
      CALL SUMSTA(IMODE,JZ,ASTA(2,3),TURB1,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK)    
      CALL SUMSTA(IMODE,JZ,ASTA(2,4),TURB2,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK)  
      CALL SUMSTA(IMODE,JZ,ASTA(2,5),TURP1,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK)  
      CALL SUMSTA(IMODE,JZ,ASTA(2,6),TURP2,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK)    
      CALL SUMSTA(IMODE,JZ,ASTA(2,7),TURP3,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK)    
      CALL SUMSTA(IMODE,JZ,ASTA(2,8),TURP4,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK)  
      CALL SUMSTA(IMODE,JZ,ASTA(2,9),TURK1,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK)   
      CALL SUMSTA(IMODE,JZ,ASTA(2,9),TURU1,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK)   
      CALL SUMSTA(IMODE,JZ,ASTA(2,10),TURK2,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK)    
      CALL SUMSTA(IMODE,JZ,ASTA(2,10),TURU2,STASUM2,STAEGR,STASUM3, 
     *            DIRWALK,EGRWALK)  
      CALL SUMSTA(IMODE,JZ,ASTA(2,11),TURK3,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK)   
      CALL SUMSTA(IMODE,JZ,ASTA(2,11),TURU3,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK)    
      CALL SUMSTA(IMODE,JZ,ASTA(2,12),TURK4,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK)    
      CALL SUMSTA(IMODE,JZ,ASTA(2,12),TURU4,STASUM2,STAEGR,STASUM3,
     *            DIRWALK,EGRWALK)            
      END IF
C GO BUS DRIVE
...
C......GO RAIL STATION-TO-STATION
      ...
      call statsum(maxgln,orista,dessta,PERTRPCP,gorailp1)
      ...
      call statsum(maxgln,orista,dessta,PERTRPCP,gorailp2)
      ...
      call statsum(maxgln,orista,dessta,PERTRPCP,gorailp3)
      ...
      call statsum(maxgln,orista,dessta,PERTRPCP,gorailp4)
      ...
      crss(orista,dessta)=crss(orista,dessta) + sngl(tcru1)
      call statsum(maxgln,orista,dessta,tcru1,gorail)
      call upxsum(orista,dessta,tcru1,upxsta,stasum6)
      ...
      crss(orista,dessta)=crss(orista,dessta) + sngl(tcru2)
      call statsum(maxgln,orista,dessta,tcru2,gorail)
      call upxsum(orista,dessta,tcru2,upxsta,stasum6)
      ...
      crss(orista,dessta)=crss(orista,dessta) + sngl(tcru3)
      call statsum(maxgln,orista,dessta,tcru3,gorail)
      call upxsum(orista,dessta,tcru3,upxsta,stasum6)
      ...
      crss(orista,dessta)=crss(orista,dessta) + sngl(tcru4)
      call statsum(maxgln,orista,dessta,tcru4,gorail)
      call upxsum(orista,dessta,tcru4,upxsta,stasum6)
C.....TTC SUBWAY STATION-TO-STATION EGRESS FOR GO RAIL TRIPS
      ...
      crurss(orista,dessta)=crurss(orista,dessta) + sngl(tcru1)
...
C.....TTC SUBWAY STATION-TO-STATION
      ...
      urss(orista,dessta)=urss(orista,dessta) + sngl(turu1)
      call statsum(maxtln,orista,dessta,turu1,ttcsubway)
      ...
      urss(orista,dessta)=urss(orista,dessta) + sngl(turu2)
      call statsum(maxtln,orista,dessta,turu2,ttcsubway)
      ...
      urss(orista,dessta)=urss(orista,dessta) + sngl(turu3)
      call statsum(maxtln,orista,dessta,turu3,ttcsubway)
      ...
      urss(orista,dessta)=urss(orista,dessta) + sngl(turu4)
      call statsum(maxtln,orista,dessta,turu4,ttcsubway)
...
C.....GO RAIL STATION TO ZONE VIA BUS
      ...
      crstaz(dessta,jz)=crstaz(dessta,jz) + sngl(tcru1)
      end if
      dessta=asta(1,10)-MAX_IZONES
      if(egrind(1,10).eq.0.and.staind(dessta,jz).eq.2) then
      crstaz(dessta,jz)=crstaz(dessta,jz) + sngl(tcrk2)
      crstaz(dessta,jz)=crstaz(dessta,jz) + sngl(tcru2)
      end if
      dessta=asta(1,11)-MAX_IZONES
      if(egrind(1,11).eq.0.and.staind(dessta,jz).eq.2) then
      crstaz(dessta,jz)=crstaz(dessta,jz) + sngl(tcrk3)
      crstaz(dessta,jz)=crstaz(dessta,jz) + sngl(tcru3)
      end if
      dessta=asta(1,12)-MAX_IZONES
      if(egrind(1,12).eq.0.and.staind(dessta,jz).eq.2) then
      crstaz(dessta,jz)=crstaz(dessta,jz) + sngl(tcrk4)
      crstaz(dessta,jz)=crstaz(dessta,jz) + sngl(tcru4)
      end if
      else
      imode=1
      call sumtrp(imode,jz,asta(1,1),egrind(1,1),tcrw1,
     *            crwlk,crstaz,cruber,staegr)
      call sumtrp(imode,jz,asta(1,2),egrind(1,2),tcrw2,
     *            crwlk,crstaz,cruber,staegr)
      call sumtrp(imode,jz,asta(1,3),egrind(1,3),tcrb1,
     *            crwlk,crstaz,cruber,staegr)
      call sumtrp(imode,jz,asta(1,4),egrind(1,4),tcrb2,
     *            crwlk,crstaz,cruber,staegr)
      call sumtrp(imode,jz,asta(1,5),egrind(1,5),tcrp1,
     *            crwlk,crstaz,cruber,staegr)
      call sumtrp(imode,jz,asta(1,6),egrind(1,6),tcrp2,
     *            crwlk,crstaz,cruber,staegr)
      call sumtrp(imode,jz,asta(1,7),egrind(1,7),tcrp3,
     *            crwlk,crstaz,cruber,staegr)
      call sumtrp(imode,jz,asta(1,8),egrind(1,8),tcrp4,
     *            crwlk,crstaz,cruber,staegr)
      call sumtrp(imode,jz,asta(1,9),egrind(1,9),tcrk1,
     *            crwlk,crstaz,cruber,staegr)
      call sumtrp(imode,jz,asta(1,9),egrind(1,9),tcru1,
     *            crwlk,crstaz,cruber,staegr)
      call sumtrp(imode,jz,asta(1,10),egrind(1,10),tcrk2,
     *            crwlk,crstaz,cruber,staegr)
      call sumtrp(imode,jz,asta(1,10),egrind(1,10),tcru2,
     *            crwlk,crstaz,cruber,staegr)
      call sumtrp(imode,jz,asta(1,11),egrind(1,11),tcrk3,
     *            crwlk,crstaz,cruber,staegr)
      call sumtrp(imode,jz,asta(1,11),egrind(1,11),tcru3,
     *            crwlk,crstaz,cruber,staegr)
      call sumtrp(imode,jz,asta(1,12),egrind(1,12),tcrk4,
     *            crwlk,crstaz,cruber,staegr)
      call sumtrp(imode,jz,asta(1,12),egrind(1,12),tcru4,
     *            crwlk,crstaz,cruber,staegr)
      end if
C.....TTC SUBWAY RAIL WALK EGRESS STATION TO ZONE FOR GO RAIL TRIPS
      ...
      crurwlk(dessta,jz)=crurwlk(dessta,jz) + sngl(tcru1)
      end if
      dessta=asta3(1,10)-MAX_IZONES
      if(staind(dessta,jz).eq.1) then
      crurwlk(dessta,jz)=crurwlk(dessta,jz) + sngl(tcrk2)
      crurwlk(dessta,jz)=crurwlk(dessta,jz) + sngl(tcru2)
      end if
      dessta=asta3(1,11)-MAX_IZONES
      if(staind(dessta,jz).eq.1) then
      crurwlk(dessta,jz)=crurwlk(dessta,jz) + sngl(tcrk3)
      crurwlk(dessta,jz)=crurwlk(dessta,jz) + sngl(tcru3)
      end if
      dessta=asta3(1,12)-MAX_IZONES
      if(staind(dessta,jz).eq.1) then
      crurwlk(dessta,jz)=crurwlk(dessta,jz) + sngl(tcrk4)
      crurwlk(dessta,jz)=crurwlk(dessta,jz) + sngl(tcru4)
      end if
C.....TTC SUBWAY RAIL STATION TO ZONE FOR GO RAIL TRIPS
      ...
      crurstaz(dessta,jz)=crurstaz(dessta,jz) + sngl(tcru1)
      end if
      dessta=asta3(1,10)-MAX_IZONES
      if(staind(dessta,jz).eq.2) then
      crurstaz(dessta,jz)=crurstaz(dessta,jz) + sngl(tcrk2)
      crurstaz(dessta,jz)=crurstaz(dessta,jz) + sngl(tcru2)
      end if
      dessta=asta3(1,11)-MAX_IZONES
      if(staind(dessta,jz).eq.2) then
      crurstaz(dessta,jz)=crurstaz(dessta,jz) + sngl(tcrk3)
      crurstaz(dessta,jz)=crurstaz(dessta,jz) + sngl(tcru3)
      end if
      dessta=asta3(1,12)-MAX_IZONES
      if(staind(dessta,jz).eq.2) then
      crurstaz(dessta,jz)=crurstaz(dessta,jz) + sngl(tcrk4)
      crurstaz(dessta,jz)=crurstaz(dessta,jz) + sngl(tcru4)
      end if
      else
      imode=1
      call sumtrp(imode,jz,asta3(1,1),0,tcrw1,
     *            crurwlk,crurstaz,cruruber,staegr)
      call sumtrp(imode,jz,asta3(1,2),0,tcrw2,
     *            crurwlk,crurstaz,cruruber,staegr)
      call sumtrp(imode,jz,asta3(1,3),0,tcrb1,
     *            crurwlk,crurstaz,cruruber,staegr)
      call sumtrp(imode,jz,asta3(1,4),0,tcrb2,
     *            crurwlk,crurstaz,cruruber,staegr)
      call sumtrp(imode,jz,asta3(1,5),0,tcrp1,
     *            crurwlk,crurstaz,cruruber,staegr)
      call sumtrp(imode,jz,asta3(1,6),0,tcrp2,
     *            crurwlk,crurstaz,cruruber,staegr)
      call sumtrp(imode,jz,asta3(1,7),0,tcrp3,
     *            crurwlk,crurstaz,cruruber,staegr)
      call sumtrp(imode,jz,asta3(1,8),0,tcrp4,
     *            crurwlk,crurstaz,cruruber,staegr)
      call sumtrp(imode,jz,asta3(1,9),0,tcrk1,
     *            crurwlk,crurstaz,cruruber,staegr)
      call sumtrp(imode,jz,asta3(1,9),0,tcru1,
     *            crurwlk,crurstaz,cruruber,staegr)
      call sumtrp(imode,jz,asta3(1,10),0,tcrk2,
     *            crurwlk,crurstaz,cruruber,staegr)
      call sumtrp(imode,jz,asta3(1,10),0,tcru2,
     *            crurwlk,crurstaz,cruruber,staegr)
      call sumtrp(imode,jz,asta3(1,11),0,tcrk3,
     *            crurwlk,crurstaz,cruruber,staegr)
      call sumtrp(imode,jz,asta3(1,11),0,tcru3,
     *            crurwlk,crurstaz,cruruber,staegr)
      call sumtrp(imode,jz,asta3(1,12),0,tcrk4,
     *            crurwlk,crurstaz,cruruber,staegr)
      call sumtrp(imode,jz,asta3(1,12),0,tcru4,
     *            crurwlk,crurstaz,cruruber,staegr)
      end if
C.....TTC SUBWAY WALK EGRESS STATION-T0-DESTINATION ZONE
      ...
      urwlk(dessta,jz)=urwlk(dessta,jz) + sngl(turu1)
      end if
      dessta=asta(2,10)-MAX_IZONES
      if(staind(dessta,jz).eq.1) then
      urwlk(dessta,jz)=urwlk(dessta,jz) + sngl(turk2)
      urwlk(dessta,jz)=urwlk(dessta,jz) + sngl(turu2)
      end if
      dessta=asta(2,11)-MAX_IZONES
      if(staind(dessta,jz).eq.1) then
      urwlk(dessta,jz)=urwlk(dessta,jz) + sngl(turk3)
      urwlk(dessta,jz)=urwlk(dessta,jz) + sngl(turu3)
      end if
      dessta=asta(2,12)-MAX_IZONES
      if(staind(dessta,jz).eq.1) then
      urwlk(dessta,jz)=urwlk(dessta,jz) + sngl(turk4)
      urwlk(dessta,jz)=urwlk(dessta,jz) + sngl(turu4)
      end if
C.....TTC SUBWAY STATION-T0-DESTINATION ZONE
      ...
      urstaz(dessta,jz)=urstaz(dessta,jz) + sngl(turu1)
      end if
      dessta=asta(2,10)-MAX_IZONES
      if(staind(dessta,jz).eq.2) then
      urstaz(dessta,jz)=urstaz(dessta,jz) + sngl(turk2)
      urstaz(dessta,jz)=urstaz(dessta,jz) + sngl(turu2)
      end if
      dessta=asta(2,11)-MAX_IZONES
      if(staind(dessta,jz).eq.2) then
      urstaz(dessta,jz)=urstaz(dessta,jz) + sngl(turk3)
      urstaz(dessta,jz)=urstaz(dessta,jz) + sngl(turu3)
      end if
      dessta=asta(2,12)-MAX_IZONES
      if(staind(dessta,jz).eq.2) then
      urstaz(dessta,jz)=urstaz(dessta,jz) + sngl(turk4)
      urstaz(dessta,jz)=urstaz(dessta,jz) + sngl(turu4)
      end if
      else
      imode=2
      call sumtrp(imode,jz,asta(2,1),0,turw1,
     *            urwlk,urstaz,uruber,staegr)
      call sumtrp(imode,jz,asta(2,2),0,turw2,
     *            urwlk,urstaz,uruber,staegr)
      call sumtrp(imode,jz,asta(2,3),0,turb1,
     *            urwlk,urstaz,uruber,staegr)
      call sumtrp(imode,jz,asta(2,4),0,turb2,
     *            urwlk,urstaz,uruber,staegr)
      call sumtrp(imode,jz,asta(2,5),0,turp1,
     *            urwlk,urstaz,uruber,staegr)
      call sumtrp(imode,jz,asta(2,6),0,turp2,
     *            urwlk,urstaz,uruber,staegr)
      call sumtrp(imode,jz,asta(2,7),0,turp3,
     *            urwlk,urstaz,uruber,staegr)
      call sumtrp(imode,jz,asta(2,8),0,turp4,
     *            urwlk,urstaz,uruber,staegr)
      call sumtrp(imode,jz,asta(2,9),0,turk1,
     *            urwlk,urstaz,uruber,staegr)
      call sumtrp(imode,jz,asta(2,10),0,turk2,
     *            urwlk,urstaz,uruber,staegr)
      call sumtrp(imode,jz,asta(2,11),0,turk3,
     *            urwlk,urstaz,uruber,staegr)
      call sumtrp(imode,jz,asta(2,12),0,turk4,
     *            urwlk,urstaz,uruber,staegr)
      call sumtrp(imode,jz,asta(2,9),0,turu1,
     *            urwlk,urstaz,uruber,staegr)
      call sumtrp(imode,jz,asta(2,10),0,turu2,
     *            urwlk,urstaz,uruber,staegr)
      call sumtrp(imode,jz,asta(2,11),0,turu3,
     *            urwlk,urstaz,uruber,staegr)
      call sumtrp(imode,jz,asta(2,12),0,turu4,
     *            urwlk,urstaz,uruber,staegr)
      end if
c...WALK TO GO RAIL
      orista=osta(1,1)-MAX_IZONES
...
c...UBER TO GO RAIL & TTC SUBWAY
      orista=osta(1,9)-MAX_IZONES
      utran(iz,orista)=utran(iz,orista) + sngl(tcru1)
      orista=osta(1,10)-MAX_IZONES
      utran(iz,orista)=utran(iz,orista) + sngl(tcru2)
      orista=osta(1,11)-MAX_IZONES
      utran(iz,orista)=utran(iz,orista) + sngl(tcru3)
      orista=osta(1,12)-MAX_IZONES
      utran(iz,orista)=utran(iz,orista) + sngl(tcru4)
      orista=osta(2,9)-MAX_IZONES
      utran(iz,orista)=utran(iz,orista) + sngl(turu1)
      orista=osta(2,10)-MAX_IZONES
      utran(iz,orista)=utran(iz,orista) + sngl(turu2)
      orista=osta(2,11)-MAX_IZONES
      utran(iz,orista)=utran(iz,orista) + sngl(turu3)
      orista=osta(2,12)-MAX_IZONES
      utran(iz,orista)=utran(iz,orista) + sngl(turu4)
c...DRIVE TO GO BUS
...
C
 ...
 9744 FORMAT(I4,',',I4,',',I2,7(',',F12.5),12(',',I4))
      END IF
C
C KEEP TRACK OF PRIMARY MODE SPLIT BY CARPOOL PROPENSITY SEGMENT
C FOR ASSESSING MAX AND MIN SHARES DURING CALIBRATION
C
      CPMS(C,CP,1)=CPMS(C,CP,1)+TDRV0
      CPMS(C,CP,2)=CPMS(C,CP,2)+TDRV2
      CPMS(C,CP,3)=CPMS(C,CP,3)+TDRV3
      CPMS(C,CP,4)=CPMS(C,CP,4)+TTRAN
      CPMS(C,CP,5)=CPMS(C,CP,5)+TNMOT
      CPMS(C,CP,6)=CPMS(C,CP,6)+TSCHBUS
      CPMS(C,CP,7)=CPMS(C,CP,7)+PERTRPCP
C
      CPMS(7,CP,1)=CPMS(7,CP,1)+TDRV0
      CPMS(7,CP,2)=CPMS(7,CP,2)+TDRV2
      CPMS(7,CP,3)=CPMS(7,CP,3)+TDRV3
      CPMS(7,CP,4)=CPMS(7,CP,4)+TTRAN
      CPMS(7,CP,5)=CPMS(7,CP,5)+TNMOT
      CPMS(7,CP,6)=CPMS(7,CP,6)+TSCHBUS
      CPMS(7,CP,7)=CPMS(7,CP,7)+PERTRPCP
C
C ----- Carpool Propensity Segmentation Loop End
 1900 CONTINUE
C   
...
C
      ...
      END IF
C *********************************************************
C   OUTPUT TRESO PROBABILITY,STATION & EGRESS SPLIT FILE
C *********************************************************
      IF(TRESO) THEN
C..PROBABILITY VALUES
      DO K3=1,NCATS
      IF(TPERIN(K3).LE.0.0) CYCLE
      K4=(K3-1)*4+1
      K5=K4+3
      WRITE(208) IEQUIV(IZ),IEQUIV(JZ),K3,
     *               ((TRESODAT(K2,K1),K2=1,52),K1=K4,K5)
      IF(TDEBUG) WRITE(211,9172) IEQUIV(IZ),IEQUIV(JZ),K3,
     *               ((TRESODAT(K2,K1),K2=1,52),K1=K4,K5)
 9172 FORMAT(I4,',',I4,',',I2,208(',',F10.5))
C9172 FORMAT(I4,',',I4,',',I2,52(',',F10.5)/,
C    *       ',,',52(',',F10.5)/,
C    *       ',,',52(',',F10.5)/,
C    *       ',,',52(',',F10.5))
      END DO
C..STATION VALUES
      ...
      PRGRSTA2=0
      END IF
      WRITE(209) IEQUIV(IZ),IEQUIV(JZ),
     *  (PROSTA(1,K),K=1,12),(PRASTA(1,K1),K1=1,12),
     *  (PROSTA(2,K2),K2=1,12),(PRASTA(2,K3),K3=1,12),PRCSTAT,
     *  (PROSTA3(1,K4),K4=1,12),(PRASTA3(1,K5),K5=1,12),
     *  PRGRSTA1,PRGRSTA2
      IF(TDEBUG) WRITE(211,9066) IEQUIV(IZ),IEQUIV(JZ),
     *  (PROSTA(1,K),K=1,12),(PRASTA(1,K1),K1=1,12),
     *  (PROSTA(2,K2),K2=1,12),(PRASTA(2,K3),K3=1,12),PRCSTAT,
     *  (PROSTA3(1,K4),K4=1,12),(PRASTA3(1,K5),K5=1,12),
     *  PRGRSTA1,PRGRSTA2
 9066 FORMAT(I4,',',I4,75(',',I4))
C..EGRESS SHARES
      DO K=1,12
      ASTA4(K)=ASTA(1,K)-MAX_IZONES
      IF(ASTA3(1,K).GT.0.AND.ASTA3(1,K).LT.MAX_ZONES) 
     *       ASTA4(K)=ASTA3(1,K)-MAX_IZONES
      ASTA4(K+12)=ASTA(2,K)-MAX_IZONES
      IF(ASTA3(2,K).GT.0.AND.ASTA3(2,K).LT.MAX_ZONES) 
     *      ASTA4(K+12)=ASTA3(2,K)-MAX_IZONES
      END DO
      DO K=1,12
C     IF(DEBUG) WRITE(26,9067) IEQUIV(ASTA(1,K)),IEQUIV(ASTA3(1,K)),
C    *               IEQUIV(ASTA(2,K)),IEQUIV(ASTA3(2,K)),
C    *               ASTA4(K),ASTA4(K+12),
C    *               STAEGR(1,ASTA4(K),JZ),STAEGR(2,ASTA4(K),JZ),
C    *               STAEGR(1,ASTA4(K+12),JZ),STAEGR(2,ASTA4(K+12),JZ)
C9067 FORMAT(6(1X,I4),4(1X,F6.4))
      END DO 
      DO K=1,24
      PRASTA4(K)=IEQUIV(ASTA4(K)+MAX_IZONES)
      END DO
      IF(TDEBUG) WRITE(211,9068) IEQUIV(IZ),IEQUIV(JZ),
     *(PRASTA4(K),STAEGR(1,ASTA4(K),JZ),STAEGR(2,ASTA4(K),JZ),K=1,24)
 9068 FORMAT(I4,',',I4,',',
     *       I4,',',F6.4,',',F6.4,23(',',I4,',',F6.4,',',F6.4))
      WRITE(210) IEQUIV(IZ),IEQUIV(JZ),
     *(PRASTA4(K),STAEGR(1,ASTA4(K),JZ),STAEGR(2,ASTA4(K),JZ),K=1,24)
      END IF
C
...
C..................................................................
      ...
      PRINTZN=0
      IF(APRKZONE(JZ).GT.0) PRINTZN=IEQUIV(APRKZONE(JZ))
      WRITE(26,9626) (APARKTRP(K,1),K=1,3),PRINTZN,
     *               (APARKTRP(K1,2),K1=1,3)
 9626 FORMAT(' ALTERNATIVE PARKING TRIP SUMMARY'/
     *       ' --------------------------------'/
     *       ' --- RETURN HOME ---'/
     *       ' DRIVE ALONE=',F8.2/
     *       ' 2 PERSON   =',F8.2/
...
C........................................................................
      ...
      WRITE(272,REC=RECNO) APARKTRP(1,1)
      WRITE(273,REC=RECNO) APARKTRP(2,1)
      WRITE(274,REC=RECNO) APARKTRP(3,1)
      IF(APRKZONE(JZ).GT.0) THEN
      RECNO = ((JZ-1)*MXZONES) + APRKZONE(JZ)
      WRITE(275,REC=RECNO) APARKTRP(1,2)
      WRITE(276,REC=RECNO) APARKTRP(2,2)
      WRITE(277,REC=RECNO) APARKTRP(3,2)
      END IF
      END IF
C
...
C      
      IF(VEHOUT.AND.(.NOT.AIRTRN)) THEN
      IIZ=IZ
      DO T=1,10
      FILENO=160+T
      WRITE(FILENO) IIZ,(AUTTRP(K,T),K=1,4000)
      END DO
      IF(TAXIMODE) WRITE(206) IIZ,(AUTTRP(K,11),K=1,4000)
      IF(UBERMODE) WRITE(207) IIZ,(AUTTRP(K,12),K=1,4000)
      IF(AVMDL) THEN
      DO T=13,22
      FILENO=248+T
      WRITE(FILENO) IIZ,(AUTTRP(K,T),K=1,4000)
      END DO     
      IF(TAXIMODE) WRITE(271) IIZ,(AUTTRP(K,23),K=1,4000)      
      END IF
      END IF
C
C  OUTPUT TRANSIT ZONE LEVEL MATRICES
C
      IF(TRIPSOUT.AND.(.NOT.AIRTRN)) THEN
      IIZ=IZ
      DO T=1,10
      FILENO=50+T
...
C
 ...
 9151 FORMAT(/2X,'TOTAL',32X,10(1X,F9.0))
      END IF
C
C     OUTPUT AUTO PERSON ATTRACTION VALUES FOR USE IN PARKING COST MODEL
C
      if(vehatr) then
      do jz=1,max_izones
      denom=0.0
      do k=1,10
      denom=denom+vehattr(jz,k)
      end do
      if(denom.gt.0.0) write(212,9069) 
     *     iequiv(jz),(vehattr(jz,k),k=1,11)
 9069 format(i4,11(',',f12.2))
      end do
      end if
C ===================================================================
C     TRIP REPORTING
...
C     IF(VSKIM) GO TO 8890
 ...
 7001 FORMAT(//,30X,'R E P O R T   1',/,
     ...
     *          ' TRANSIT','   MOTORIZED',2X,'    BUS  ','   MAAS   ',
     *          '   TOTAL  '/
     *       1X,'---------','---------','---------','----------',
     *          '----------','----------','----------','----------',
     *          '----------')
      DO C=1,NCATS
      TDRV0=TESUM(21,C)+TESUM(22,C)+TESUM(47,C)+TESUM(48,C)
      TDRV2=TESUM(23,C)+TESUM(24,C)+TESUM(25,C)+TESUM(26,C)+
     *      TESUM(49,C)+TESUM(50,C)+TESUM(51,C)+TESUM(52,C)
      TDRV3=TESUM(27,C)+TESUM(28,C)+TESUM(29,C)+TESUM(30,C)+
     *      TESUM(53,C)+TESUM(54,C)+TESUM(55,C)+TESUM(56,C)     
      WRITE(26,7002) C,TDRV0,TDRV2,TDRV3,TESUM(2,C),
     *               TESUM(36,C),TESUM(6,C),TESUM(43,C),TESUM(1,C)
 7002 FORMAT(5X,I1,2X,8F10.0)
      IF(CSVRPT) THEN
 ...
 7050 FORMAT(I1,15(',',F10.0))      
      ...
      END IF
      END DO
      TDRV0=TESUM(21,CI)+TESUM(22,CI)+TESUM(47,CI)+TESUM(48,CI)
      TDRV2=TESUM(23,CI)+TESUM(24,CI)+TESUM(25,CI)+TESUM(26,CI)+
     *      TESUM(49,CI)+TESUM(50,CI)+TESUM(51,CI)+TESUM(52,CI)
      TDRV3=TESUM(27,CI)+TESUM(28,CI)+TESUM(29,CI)+TESUM(30,CI)+
     *      TESUM(53,CI)+TESUM(54,CI)+TESUM(55,CI)+TESUM(56,CI)     
      WRITE(26,7003) TDRV0,TDRV2,TDRV3,TESUM(2,CI),
     *               TESUM(36,CI),TESUM(6,CI),TESUM(43,CI),TESUM(1,CI)
 7003 FORMAT(/' TOTAL  ',8F10.0)
...
C
 ...
 9226 FORMAT(//,30X,'R E P O R T   1B(2)',/,
     ...
     *          '---------','---------','---------')
      DO C=1,NCATS
      WRITE(26,9302) C,(TESUM(T,C),T=47,56)
      IF(CSVRPT) WRITE(173,7050) C,(TESUM(T,C),T=47,56)
      END DO
      WRITE(26,9303) (TESUM(T,CI),T=47,56)
       IF(CSVRPT) WRITE(173,7051) (TESUM(T,CI),T=47,56)
       END IF
      WRITE(26,9901)
 ...
 9903 FORMAT(/,2X,'TOTAL',1X,2F10.0)
      IF(CARPOOL) THEN
      WRITE(26,9910)
 9910 FORMAT(//,30X,'R E P O R T   1D',/,
     *          20X,
     *          'TRIPS BY MODE AND CARPOOL PROPENSITY SEGMENT',//,
     *       1X,' CARPOOL   ','         ','    2    ','      3    '/
     *       1X,' SEGMENT  ','  DRIVE  ','  PERSON ','    PERSON ',
     *      10X,'   NON    ',' SCHOOL  '/
     *       1X,'  LEVEL  ','   ALONE ','    AUTO ','      AUTO ',
     ...
     *          '----------','----------','----------','----------')
      DO CP=1,3
      WRITE(26,9911) CP,(CPMS(7,CP,MX),MX=1,7)
 9911 FORMAT(5X,I1,2X,7F10.0)
      END DO
 
      WRITE(26,9912)
 9912 FORMAT(//,30X,'R E P O R T   1E',/,
     *          20X,
     *          'SOV CAPTIVE TRIPS BY MODE AND MARKET SEGMENT',//,
     *       1X,' MARKET   ','         ','    2    ','      3    '/
     *       1X,' SEGMENT  ','  DRIVE  ','  PERSON ','    PERSON ',
     *      10X,'   NON    ',' SCHOOL  '/
     *       1X,'  LEVEL  ','   ALONE ','    AUTO ','      AUTO ',
     ...
     *          '----------','----------','----------','----------')
      DO C=1,6
      WRITE(26,9913) C,(CPMS(C,1,MX),MX=1,7)
 9913 FORMAT(5X,I1,2X,7F10.0)
      END DO
 
      WRITE(26,9914)
 9914 FORMAT(//,30X,'R E P O R T   1F',/,
     *          20X,
     *          'HOV CAPTIVE TRIPS BY MODE AND MARKET SEGMENT',//,
     *       1X,' MARKET   ','         ','    2    ','      3    '/
     *       1X,' SEGMENT  ','  DRIVE  ','  PERSON ','    PERSON ',
     *      10X,'   NON    ',' SCHOOL  '/
     *       1X,'  LEVEL  ','   ALONE ','    AUTO ','      AUTO ',
     ...
     *          '----------','----------','----------','----------')
      DO C=1,6
      WRITE(26,9915) C,(CPMS(C,2,MX),MX=1,7)
 9915 FORMAT(5X,I1,2X,7F10.0)
      END DO
      END IF
      IF(.NOT.BACKVER) THEN
      WRITE(26,9905)
 9905 FORMAT(//,30X,'R E P O R T   1G',/,
     ...
     *       1X,'---------','---------','---------','---------'/)
      DO C=1,NCATS
      WRITE(26,9907) C,TESUM(41,C),TESUM(42,C),TESUM(57,C)
      IF(CSVRPT) WRITE(173,7050) C,TESUM(41,C),TESUM(42,C),TESUM(57,C)
      END DO
      WRITE(26,9908) TESUM(41,CI),TESUM(42,CI),TESUM(57,CI)
      IF(CSVRPT) WRITE(173,7051) TESUM(41,CI),TESUM(42,CI),TESUM(57,CI)
      WRITE(26,9906)
 9906 FORMAT(//,30X,'R E P O R T   1H',/,
     ...
     *       1X,'---------','---------','---------','---------')
      DO C=1,NCATS
      WRITE(26,9907) C,TESUM(44,C),TESUM(45,C),TESUM(46,C)
 9907 FORMAT(5X,I1,2X,3F10.0)
      IF(CSVRPT) WRITE(173,7050) C,TESUM(44,C),TESUM(45,C),TESUM(46,C)
      END DO
      WRITE(26,9908) TESUM(44,CI),TESUM(45,CI),TESUM(46,CI)
 9908 FORMAT(/,2X,'TOTAL',1X,3F10.0)
      IF(CSVRPT) WRITE(173,7051) TESUM(44,CI),TESUM(45,CI),TESUM(46,CI)
      END IF
      WRITE(26,7004)
...
C
 ...
 7207 FORMAT(//,30X,'R E P O R T   3',/,
     ...
     *          '----------')
      DO C=1,NCATS
      WRITE(26,7209) C,(TESUM(K,C),K=9,12),TESUM(58,C),TESUM(3,C)
 7209 FORMAT(5X,I1,2X,6F10.1)
      END DO
      WRITE(26,7010) (TESUM(K,CI),K=9,12),TESUM(58,CI),TESUM(3,CI)
      ELSE
      WRITE(26,7007)
 7007 FORMAT(//,30X,'R E P O R T   3',/,
     ...
     *          '----------','----------','----------','----------')
      DO C=1,NCATS
      WRITE(26,7009) C,(TESUM(K,C),K=9,12),TESUM(39,C),TESUM(3,C)
 7009 FORMAT(5X,I1,2X,6F10.1)
      IF(CSVRPT) WRITE(173,7050) C,(TESUM(K,C),K=9,12),TESUM(39,C),
     *                           TESUM(3,C)
      END DO
      WRITE(26,7010) (TESUM(K,CI),K=9,12),TESUM(39,CI),TESUM(3,CI)
 7010 FORMAT(/,2X,'TOTAL',1X,6F10.1)
      IF(CSVRPT) WRITE(173,7051) (TESUM(K,CI),K=9,12),TESUM(39,CI),
     *                           TESUM(3,CI)
      END IF
      WRITE(26,7011)
 7011 FORMAT(//,30X,'R E P O R T   4',/,
     ...
     *          '----------','----------','----------','----------')
      DO C=1,NCATS
      WRITE(26,7009) C,(TESUM(K,C),K=13,16),TESUM(40,C),TESUM(4,C)
      IF(CSVRPT) WRITE(173,7050) C,(TESUM(K,C),K=13,16),TESUM(40,C),
     *                          TESUM(4,C)
      END DO
      WRITE(26,7010) (TESUM(K,CI),K=13,16),TESUM(40,CI),TESUM(4,CI)
      IF(CSVRPT) WRITE(173,7051) (TESUM(K,CI),K=13,16),TESUM(40,CI),
     *                           TESUM(4,CI)
C
      WRITE(26,7031)
...
C
 ...
 7020 FORMAT(//,30X,'R E P O R T   5A',/,
     ...
     *            STASUM(K,12)
      TTWLK=TTWLK+STASUM(K,1)
	    ...
	    TTPNR=TTPNR+STASUM(K,3)
	    TTKNR=TTKNR+STASUM(K,4)
	    TTUBR=TTUBR+STASUM(K,12)
	    TTOTAL=TTOTAL+STASUM(K,5)
      IF(STASUM(K,5).GT.0.1) THEN
	    WRITE(26,7021) IEQUIV(KS),STANAME(K),(STASUM(K,L),L=1,4),
     *               STASUM(K,12),STASUM(K,5)
 7021    FORMAT(2X,I4,3X,A29,1X,6F8.0)
      IF(CSVRPT) WRITE(173,7052) IEQUIV(KS),STANAME(K),
     *           (STASUM(K,L),L=1,4),STASUM(K,12),STASUM(K,5)
 7052 FORMAT(I4,',',A29,10(',',F8.0))
      END IF
      END DO
      WRITE(26,7022) TTWLK,TTBUS,TTPNR,TTKNR,TTUBR,TTOTAL
 7022 FORMAT(/3X,'TOTAL',31X,6F8.0)
      IF(CSVRPT) WRITE(173,7053) TTWLK,TTBUS,TTPNR,TTKNR,TTUBR,TTOTAL
 ...
 7065 FORMAT(//,30X,'R E P O R T   5C',/,
     ...
     *                  (STASUM3(K,L),L=1,3)
      ...
      TTOTAL=0.0
      WRITE(26,7165)
 7165 FORMAT(//,30X,'R E P O R T   5C',/,
     *          20X,
     *          'SUMMARIZE URBAN RAIL STATION VOLUMES FOR',
     *          ' EGRESS FROM GO RAIL TRIPS',//,
     *       1X,' STATION ','                              ',
     ...
     *          '--------')
      DO K=1,MAX_STATIONS
      KS=K+MAX_IZONES
      STASUM3(K,5)=STASUM3(K,2)+STASUM3(K,3)+STASUM3(K,4)
      TTKNR=TTKNR+STASUM3(K,1)
      TTWLK=TTWLK+STASUM3(K,2)
      TTBUS=TTBUS+STASUM3(K,3)
      TTPNR=TTPNR+STASUM3(K,4)
      TTOTAL=TTOTAL+STASUM3(K,5)
      IF(STASUM3(K,1).GT.0.1.OR.STASUM3(K,5).GT.0.1) THEN
	    WRITE(26,7026) IEQUIV(KS),STANAME(K),
     *                  (STASUM3(K,L),L=1,5)
	    IF(CSVRPT) WRITE(173,7052) IEQUIV(KS),STANAME(K),
     *                  (STASUM3(K,L),L=1,5)
      END IF
      END DO
      WRITE(26,7022) TTKNR,TTWLK,TTBUS,TTPNR,TTOTAL
      IF(CSVRPT) WRITE(173,7053) TTKNR,TTWLK,TTBUS,TTPNR,TTOTAL
      END IF  
      IF(.NOT.TTCACC) STASUM4=0.0    
      TTWLK=0.0
      TTBUS=0.0
      TTOTAL=0.0
      WRITE(26,7066)
 7066 FORMAT(//,30X,'R E P O R T   5D',/,
     ...
     *          '--------','--------','------  ')
      ...
      IF(STASUM4(K,3).GT.0.1.OR.(K.EQ.MAX_STATIONS)) THEN
	    WRITE(26,7026) IEQUIV(KS),STANAME(K),
     *                  (STASUM4(K,L),L=1,3)
	    IF(CSVRPT) WRITE(173,7052) IEQUIV(KS),STANAME(K),
     *                  (STASUM4(K,L),L=1,3)
 ...
 7028 FORMAT(//,30X,'R E P O R T   6A',/,
     ...
     *             STASUM(K,13)
      TTWLK=TTWLK+STASUM(K,6)
	    ...
	    TTUBR=TTUBR+STASUM(K,13)
	    TTOTAL=TTOTAL+STASUM(K,10)
      IF(STASUM(K,10).GT.0.1) THEN
      WRITE(26,7021) IEQUIV(KS),STANAME(K),(STASUM(K,L),L=6,9),
     *               STASUM(K,13),STASUM(K,10)
	    IF(CSVRPT) WRITE(173,7052) IEQUIV(KS),STANAME(K),
     *          (STASUM(K,L),L=6,9),STASUM(K,13),STASUM(K,10)
      END IF
      END DO
      WRITE(26,7022) TTWLK,TTBUS,TTPNR,TTKNR,TTUBR,TTOTAL
      IF(CSVRPT) WRITE(173,7053) TTWLK,TTBUS,TTPNR,TTKNR,TTUBR,TTOTAL
 ...
 7025 FORMAT(//,30X,'R E P O R T   6B',/,
     ...
     *          '--------','--------','--------','------  ')
      DO K=1,MAX_STATIONS
      KS=K+MAX_IZONES
      STASUM2(K,7)=STASUM2(K,5)+STASUM2(K,6)+STASUM2(K,8)
      TTWLK=TTWLK+STASUM2(K,5)
      TTBUS=TTBUS+STASUM2(K,6)
      TTPNR=TTPNR+STASUM2(K,8)
      TTOTAL=TTOTAL+STASUM2(K,7)
      IF(STASUM2(K,7).GT.0.1) THEN
	    WRITE(26,7026) IEQUIV(KS),STANAME(K),
     *                  (STASUM2(K,L),L=5,6),STASUM2(K,8),
     *               STASUM2(K,7)
 7026 FORMAT(2X,I4,3X,A29,1X,5F8.0)
      IF(CSVRPT) WRITE(173,7052) IEQUIV(KS),STANAME(K),
     *                  (STASUM2(K,L),L=5,6),STASUM2(K,8),
     *               STASUM2(K,7)
      END IF
...
C
      IF(CALIB) THEN
      WRITE(102,9030) 
 9030 FORMAT('TIME_RATIO,WALKIVT,WALKTIVT,WALKRAT,DRVIVT,DRVTIVT,
     *        DRVRAT')
      WRITE(150,9031) 
 9031 FORMAT('RATIO,WALKRAT,DRVRAT')
      DO K=1,101
...
C
 ...
 9517  FORMAT('BUS TRANSFER INCIDENCE SUMMARY'/
     ...
     *          'RAPID BUS',6(',',F8.0)/
     *          'GO BUS',6(',',F8.0))
C.... TAXI DISTRICT LEVEL SUMMARIES
      WRITE(214,9047) nname(4),(dname(k),k=1,(maxpd+1))
      DO K=1,(MAXPD+1)
      WRITE(214,9016) DNAME(K),(TAXISUM(K,K1),K1=1,(MAXPD+1))
      END DO  
C.... STATION EGRESS WALK TIME DISTRIBUTION
      DO K=1,51
      WRITE(217,3021) (K-1),EGRWALK(K,1),EGRWALK(K,2),
     *               EGRWALK(K,3),EGRWALK(K,4)
 3021 FORMAT(I2,4(',',F8.1))
      END DO 
      END IF
c
...
c
      if(calib) then
      write(137,313)
  313 format('GO,Rail,Available,Person,Trips')
      write(137,306) gorname
      do k=1,maxgln
...
c...station access summary
  ...
  314 format('GO Rail Station Egress Summary'/
     *       'Station,Name,Walk,Transit,Uber,Total')
      do k=1,250
      if(stanum(k).eq.1) then
      orista=iequiv(k+max_izones)
      write(138,310) 
  ...
  315 format(//'TTC Subway Station Egress Summary'/
     *       'Station,Name,Walk,Bus,Total')
      ...
      orista=iequiv(k+max_izones)
      write(138,310) 
     *       orista,staname(k),(stasum2(k,k1),k1=5,6),
     *       stasum2(k,8),stasum2(k,7)
      end if
      end do
      end if
C
...
C
      if(calib) then
      open(157,file='..\outputs\ttcsubway_sts.csv',status='unknown',
     *         form='formatted')
      write(157,318) (iequiv(k+max_izones),k=1,74)
  318 format(',',74(',',i4))
      do k=1,74
      k1=iequiv(k+max_izones)
      write(157,316) k1,staname(k),(urss(k,k2),k2=1,74)
  316 format(i5,',',a35,74(',',f10.1))
      end do
      end if
C
C     WRITE OUT TAXI WAIT TIME DISTRIBUTION VALUES
C                    TRIP LENGTH FREQUENCY DISTRIBUTION
C
      IF(TAXIMODE.AND.CALIB) THEN
      DO K=1,100
      IF(TAXIWAIT(K,7).GT.0) THEN
      WRITE(215,317) K,(TAXIWAIT(K,K1),K1=1,7)
  317 FORMAT(I3,7(',',F12.2))
      END IF
      END DO
      DO K=1,1001
      RINDEX=FLOAT(K-1)/10.0
      WRITE(216,9655) RINDEX,TAXITLF(K)
 9655 FORMAT(F5.1,',',F12.5)
      END DO
      END IF
C
C     WRITE OUT HIGHWAY RELIABILITY FREQUENCY DISTRIBUTION
C
      IF(HWYREL.AND.CALIB) THEN
      OPEN(278,FILE='HTRELTLF.CSV',STATUS='UNKNOWN',FORM='FORMATTED')
      WRITE(278,9656) 
 9656 FORMAT(',,HTREL,HTREL,HTREL,TOLTREL,TREL2P,TREL2P,TOLTREL2P,',
     *       'TOLTREL2P,TOLTREL2P,TOLTREL2P'/
     *       'TIME_FR,TIME_TO,DRIVE_ALONE,2PERSON,3PERSON,DRIVE_ALONE,',
     *       '2PERSON,3PERSON,2PERSON,2PERSON,3PERSON,3PERSON')
      K=0
      WRITE(278,9657) K,K,(HTRELTLF(1,K1),K1=1,3),TOLTRELF(1),
     *                (TREL2PTLF(1,K2),K2=1,2),
     *                (TOLTREL2PTLF(1,K3),K3=1,4)
 9657 FORMAT(I2,',',I2,10(',',F12.1))
      DO K=2,52
      WRITE(278,9657) (K-2),(K-1),(HTRELTLF(K,K1),K1=1,3),TOLTRELF(K),
     *                (TREL2PTLF(K,K2),K2=1,2),
     *                (TOLTREL2PTLF(K,K3),K3=1,4)
      END DO
      WRITE(278,9658)
 9658 FORMAT('RATIO_FR,RATIO_TO,DRIVE_ALONE,2PERSON,3PERSON')
      DENOM=0.0
      WRITE(278,9659) DENOM,DENOM,(HTRELRAT(1,K1),K1=1,3)
 9659 FORMAT(F4.1,',',F4.1,3(',',F12.1))
      DO K=2,52
      DENOM=FLOAT(K)/10.0
      WRITE(278,9659) (DENOM-0.2),(DENOM-0.1),(HTRELRAT(K,K1),K1=1,3)
      END DO
      END IF
C
 ...
 7032 format(/' Calibration Iteration ',i2/
     ...
     *            stasum,nonmot,stasum2)
      ...
      if(iter.lt.niter.and.(.not.capres)) then
       ...
       if(ccode(31).or.ccode(33).or.ccode(34).or.ccode(35)) then
       stazne=0.0
       staegr=0.0
       staznei=0.0
       zonesta=0
...
C.....DRIVE & UBER TO STATION
      ...
      DO JZ=1,MAX_STATIONS
	    DIZ=IZ+MAX_IZONES
	    DJZ=JZ+MAX_IZONES
	    TRNTRP(IZ,DJZ)=UTRAN(IZ,JZ)
	    END DO
	    END DO    
	    DO IIZ=1,4000
	    WRITE(199) IIZ,(TRNTRP(IIZ,JZ),JZ=1,4000)
	    END DO
	    END IF
...
C.....GO RAIL, TTC SUBWAY & GO BUS STATION-TO-ZONE
      ...
      DO JZ=1,MAX_IZONES
	    DIZ=IZ+MAX_IZONES
	    DJZ=JZ+MAX_IZONES
	    TRNTRP(DIZ,JZ)=CRUBER(IZ,JZ)+CRURUBER(IZ,JZ)+URUBER(IZ,JZ)
	    END DO
	    END DO    
	    DO IIZ=1,4000
	    WRITE(200) IIZ,(TRNTRP(IIZ,JZ),JZ=1,4000)
	    END DO
	    END IF
      END IF
C
...
C
      OPEN(332,FILE='..\outputs\BUS_ACCESS.RPT',STATUS='UNKNOWN',
     *         FORM='FORMATTED')
      OPEN(333,FILE='..\outputs\BUS_PERCENT.CSV',STATUS='UNKNOWN',
     *         FORM='FORMATTED')
      WRITE(333,9664)
 9664 FORMAT('ZONE,PERCENT')
      OPEN(334,FILE='..\outputs\BUSTLF.CSV',STATUS='UNKNOWN',
     *         FORM='FORMATTED')
      DO IMODE=1,2
      WRITE(332,9751) NAME(IMODE)
 9751 FORMAT(/' BUS ACCESS STATION SELECTION SUMMARY FOR ',A13/)
      DO IZ=1,MAX_IZONES
      IF(BUSTWO(IZ,IMODE,1).GT.0.OR.BUSTWO(IZ,IMODE,2).GT.0) THEN
      ORISTA=0
      IF(BUSTWO(IZ,IMODE,1).GT.0) ORISTA=IEQUIV(BUSTWO(IZ,IMODE,1))
      DESSTA=0
      IF(BUSTWO(IZ,IMODE,2).GT.0) DESSTA=IEQUIV(BUSTWO(IZ,IMODE,2))
      WRITE(332,9752) IEQUIV(IZ),ORISTA,DESSTA
 9752 FORMAT(/' IZ=',I4,' BUS ACCESS STATIONS=',2I5)
      STASEL=0
      STACHOICE=0.0
      DO JZ=1,MAX_STATIONS
     ...
     *  (BUSTWO(IZ,IMODE,2).EQ.(JZ+MAX_IZONES))) THEN
      ...
      END IF
      WRITE(332,9753) IEQUIV((JZ+MAX_IZONES)),STANAME(JZ),
     *                                     STASEL(JZ)
 9753 FORMAT(' STA=',I4,1X,A37,' NUMBER OF DEST=',I4)
      END IF
      END DO
      BCHOICE=0.0
     ...
     *          *100.0
      END IF
      WRITE(332,9754) STACHOICE,BCHOICE
 9754 FORMAT(' MATCH=',I4,' NO MATCH=',I4,' %MATCH=',F6.2)
      WRITE(333,9755) IEQUIV(IZ),BCHOICE
 9755 FORMAT(I4,',',F10.5)
      ...
      END DO  
      WRITE(334,9663)
 9663 FORMAT('PERCENT,GO_RAIL,TTC_SUBWAY')  
      DO INDEX=1,21
      TINDEX=(INDEX-1)*5
      WRITE(334,9756) TINDEX,(BUSTLF(K,INDEX),K=1,2)
 9756 FORMAT(I4,2(',',F10.1))
      END DO
      WRITE(334,9757) (BUSTLF(K,22),K=1,2)
 9757 FORMAT('TOTAL',2(',',F10.1))
C
C     FILE CLEANUP
C
 8890 CONTINUE
