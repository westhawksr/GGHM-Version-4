...
C-------------------------------------------------------------------
     ...
     *                   'TTC Subway   '/
      ...
      DSTA=MAX_ZONES
      IC=STA-MAX_IZONES
      if(sdetail.and.print) write(26,9002) iequiv(sta)
...
C
      ...
      IF(TRNEGR) UTIL=STASTA(2,IC,DC)+STAEGR(3,DC,JZ)
C.............................................................
     ...
     *               STAZNE(2,DC,JZ),DDIST,IEQUIV(DSTA)
      ELSE
      WRITE(26,9003) IEQUIV(DS),STANAME(DC),UTIL,
     *               STASTA(2,IC,DC),
     *               STAEGR(3,DC,JZ),DDIST,IEQUIV(DSTA)     
      END IF
...
C....................................................................
C     IF(DEBUG.AND.(JOI(JZ)).AND.PRINT) THEN
...
c      STOP 16
 ...
 9025 FORMAT(1X,'DESTINATION STATION --> EGRESS ZONE COMPUTATIONS'/
     ...
     *       1X,'UTILITY VALUE            =',F10.5/)    
      ELSE
      BUSHAR=1.0-STAEGR(1,DC,JZ)-STAEGR(2,DC,JZ)
      WRITE(26,9031) IEQUIV(DC+MAX_IZONES),IEQUIV(JZ),
     *               STAEGR(3,DC,JZ),STAEGR(1,DC,JZ),BUSHAR,
     *               STAEGR(2,DC,JZ)
