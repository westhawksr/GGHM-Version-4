...
C      WRITE(26,8004) IHR,IMIN,ISEC
C      WRITE(*,8004) IHR,IMIN,ISEC
C8004  FORMAT(/' Station Capacity Restraint Closure Acheived'/
C    *         ' Program Completed: ',I2,':',I2,':',I2/)
C     CLOSE(140,STATUS='DELETE')
C     STOP
      END IF
      RETURN
      END
